const qr = ".terminal-shell,.terminal-shell__mount{box-sizing:border-box;width:100%;height:100%;min-height:20rem;overflow:hidden;background:#06090d}";
var Vr = 2, Yr = 1, Xr = class {
  activate(e) {
    this._terminal = e;
  }
  dispose() {
  ...
  proposeDimensions() {
    ...
    let t = this._terminal.options.scrollback === 0 ? 0 : this._terminal.options.overviewRuler?.width || 14, i = window.getComputedStyle(this._terminal.element.parentElement), s = parseInt(i.getPropertyValue("height")), r = Math.max(0, parseInt(i.getPropertyValue("width"))), n = window.getComputedStyle(this._terminal.element), o = { top: parseInt(n.getPropertyValue("padding-top")), bottom: parseInt(n.getPropertyValue("padding-bottom")), right: parseInt(n.getPropertyValue("padding-right")), left: parseInt(n.getPropertyValue("padding-left")) }, a = o.top + o.bottom, l = o.right + o.left, h = s - a, c = r - l - t;
    return { cols: Math.max(Vr, Math.floor(c / e.css.cell.width)), rows: Math.max(Yr, Math.floor(h / e.css.cell.height)) };
  }
};
var tr = Object.defineProperty, jr = Object.getOwnPropertyDescriptor, Gr = (e, t) => {
  for (var i in t) tr(e, i, { get: t[i], enumerable: !0 });
}, Y = (e, t, i, s) => {
  for (var r = s > 1 ? void 0 : s ? jr(t, i) : t, n = e.length - 1, o; n >= 0; n--) (o = e[n]) && (r = (s ? o(t, i, r) : o(r)) || r);
  return s && r && tr(t, i, r), r;
}, w = (e, t) => (i, s) => t(i, s, e), ns = "Terminal input", ui = { get: () => ns, set: (e) => ns = e }, os = "Too much output to announce, navigate to rows manually to read", _i = { get: () => os, set: (e) => os = e };
function Jr(e) {
  return e.replace(/\r?\n/g, "\r");
}
function Zr(e, t) {
...
function ir(e, t, i, s) {
  e = Jr(e), e = Zr(e, i.decPrivateModes.bracketedPasteMode && s.rawOptions.ignoreBracketedPasteMode !== !0), i.triggerDataEvent(e, !0), t.value = "";
}
function sr(e, t, i) {
...
var tn = class {
  ...
  decode(e, t) {
    let i = e.length;
    if (!i) return 0;
    let s = 0, r, n, o, a, l = 0, h = 0;
    if (this.interim[0]) {
      let _ = !1, f = this.interim[0];
      f &= (f & 224) === 192 ? 31 : (f & 240) === 224 ? 15 : 7;
      let u = 0, p;
      for (; (p = this.interim[++u] & 63) && u < 4; ) f <<= 6, f |= p;
      let S = (this.interim[0] & 224) === 192 ? 2 : (this.interim[0] & 240) === 224 ? 3 : 4, x = S - u;
      for (; h < x; ) {
        if (h >= i) return 0;
        if (p = e[h++], (p & 192) !== 128) {
          h--, _ = !0;
          break;
        } else this.interim[u++] = p, f <<= 6, f |= p & 63;
      }
      _ || (S === 2 ? f < 128 ? h-- : t[s++] = f : S === 3 ? f < 2048 || f >= 55296 && f <= 57343 || f === 65279 || (t[s++] = f) : f < 65536 || f > 1114111 || (t[s++] = f)), this.interim.fill(0);
    }
    let c = i - 4, d = h;
    for (; d < i; ) {
      for (; d < c && !((r = e[d]) & 128) && !((n = e[d + 1]) & 128) && !((o = e[d + 2]) & 128) && !((a = e[d + 3]) & 128); ) t[s++] = r, t[s++] = n, t[s++] = o, t[s++] = a, d += 4;
      if (r = e[d++], r < 128) t[s++] = r;
      else if ((r & 224) === 192) {
        if (d >= i) return this.interim[0] = r, s;
        if (n = e[d++], (n & 192) !== 128) {
          d--;
          continue;
        }
        ...
        if (d >= i) return this.interim[0] = r, this.interim[1] = n, s;
        if (o = e[d++], (o & 192) !== 128) {
          d--;
          continue;
        }
        ...
        if (d >= i) return this.interim[0] = r, this.interim[1] = n, this.interim[2] = o, s;
        if (a = e[d++], (a & 192) !== 128) {
          d--;
          continue;
        }
        if (l = (r & 7) << 18 | (n & 63) << 12 | (o & 63) << 6 | a & 63, l < 65536 || l > 1114111) continue;
        t[s++] = l;
      }
    }
    return s;
  ...
  constructor() {
    this.fg = 0, this.bg = 0, this.extended = new Ft();
  }
  static toColorRGB(t) {
  ...
  clone() {
    return new or(this._ext, this._urlId);
  }
  isEmpty() {
    return this.underlineStyle === 0 && this._urlId === 0;
  }
}, be = class ar extends Ct {
  constructor() {
    super(...arguments), this.content = 0, this.fg = 0, this.bg = 0, this.extended = new Ft(), this.combinedData = "";
  }
  ...
  getChars() {
    return this.content & 2097152 ? this.combinedData : this.content & 2097151 ? Ke(this.content & 2097151) : "";
  }
  getCode() {
...
}, hs = "di$target", fi = "di$dependencies", Qt = /* @__PURE__ */ new Map();
function rn(e) {
  return e[fi] || [];
}
function re(e) {
  ...
  return t._id = e, Qt.set(e, t), t;
}
function nn(e, t, i) {
  t[hs] === t ? t[fi].push({ id: e, index: i }) : (t[fi] = [{ id: e, index: i }], t[hs] = t);
}
var ce = re("BufferService"), hr = re("CoreMouseService"), et = re("CoreService"), on = re("CharsetService"), ji = re("InstantiationService"), lr = re("LogService"), de = re("OptionsService"), cr = re("OscLinkService"), an = re("UnicodeService"), xt = re("DecorationService"), pi = class {
  constructor(e, t, i) {
  ...
  provideLinks(e, t) {
    ...
    let s = [], r = this._optionsService.rawOptions.linkHandler, n = new be(), o = i.getTrimmedLength(), a = -1, l = -1, h = !1;
    for (let c = 0; c < o; c++) if (!(l === -1 && !i.hasContent(c))) {
      if (i.loadCell(c, n), n.hasExtendedAttrs() && n.extended.urlId) if (l === -1) {
        l = c, a = n.extended.urlId;
        continue;
      } else h = n.extended.urlId !== a;
      else l !== -1 && (h = !0);
      if (h || l !== -1 && c === o - 1) {
        let d = this._oscLinkService.getLinkData(a)?.uri;
        if (d) {
          let _ = { start: { x: l + 1, y: e }, end: { x: c + (!h && c === o - 1 ? 1 : 0), y: e } }, f = !1;
          ...
          f || s.push({ text: d, range: _, activate: (u, p) => r ? r.activate(u, p, _) : hn(u, p), hover: (u, p) => r?.hover?.(u, p, _), leave: (u, p) => r?.leave?.(u, p, _) });
        }
        h = !1, n.hasExtendedAttrs() && n.extended.urlId ? (l = c, a = n.extended.urlId) : (l = -1, a = -1);
      }
    }
    t(s);
  }
};
pi = Y([w(0, ce), w(1, de), w(2, cr)], pi);
function hn(e, t) {
...
var Xt = re("CharSizeService"), Oe = re("CoreBrowserService"), Gi = re("MouseService"), Ie = re("RenderService"), ln = re("SelectionService"), dr = re("CharacterJoinerService"), nt = re("ThemeService"), ur = re("LinkProviderService"), cn = class {
  constructor() {
    this.listeners = [], this.unexpectedErrorHandler = function(e) {
      setTimeout(() => {
        throw e.stack ? ls.isErrorNoTelemetry(e) ? new ls(e.message + `
...
function Ot(e) {
  un(e) || dn.onUnexpectedError(e);
}
var gi = "Canceled";
function un(e) {
  return e instanceof _n ? !0 : e instanceof Error && e.name === gi && e.message === gi;
}
var _n = class extends Error {
  constructor() {
    super(gi), this.name = this.message;
  }
};
function fn(e) {
  return new Error(`Illegal argument: ${e}`);
}
var ls = class vi extends Error {
  constructor(t) {
...
}, mi = class _r extends Error {
  constructor(t) {
    super(t || "An unexpected bug occurred."), Object.setPrototypeOf(this, _r.prototype);
  }
};
function fe(e, t = 0) {
...
((e) => {
  ...
  e.from = o;
  function* a(B) {
    for (let O = B.length - 1; O >= 0; O--) yield B[O];
  }
  e.reverse = a;
  function l(B) {
  ...
  function c(B, O) {
    let D = 0;
    for (let A of B) if (O(A, D++)) return !0;
    return !1;
  }
  e.some = c;
  function d(B, O) {
    for (let D of B) if (O(D)) return D;
  }
  e.find = d;
  function* _(B, O) {
    for (let D of B) O(D) && (yield D);
  }
  e.filter = _;
  function* f(B, O) {
    let D = 0;
    for (let A of B) yield O(A, D++);
  }
  e.map = f;
  function* u(B, O) {
    let D = 0;
  ...
  e.flatMap = u;
  function* p(...B) {
    for (let O of B) yield* O;
  }
  e.concat = p;
  function S(B, O, D) {
    let A = D;
    for (let W of B) A = O(A, W);
    return A;
  }
  e.reduce = S;
  function* x(B, O, D = B.length) {
    for (O < 0 && (O += B.length), D < 0 ? D += B.length : D > B.length && (D = B.length); O < D; O++) yield B[O];
  }
  e.slice = x;
  function H(B, O = Number.POSITIVE_INFINITY) {
    let D = [];
    if (O === 0) return [D, B];
    let A = B[Symbol.iterator]();
    for (let W = 0; W < O; W++) {
      let he = A.next();
      if (he.done) return [D, e.empty()];
      D.push(he.value);
    }
...
var pr = class gr {
  ...
  add(t) {
    ...
    return this._isDisposed ? gr.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t;
  }
  delete(t) {
    if (t) {
...
}, Ae = typeof window == "object" ? window : globalThis, Si = class wi {
  constructor(t) {
    this.element = t, this.next = wi.Undefined, this.prev = wi.Undefined;
  }
};
...
}, mn = globalThis.performance && typeof globalThis.performance.now == "function", Sn = class vr {
  static create(t) {
    return new vr(t);
  }
  constructor(t) {
    this._now = mn && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1;
  }
  stop() {
...
((e) => {
  ...
  function i(k) {
    return (v, C = null, b) => {
      let E = !1, M;
      return M = k((y) => {
        if (!E) return M ? M.dispose() : E = !0, v.call(C, y);
      }, null, b), E && M.dispose(), M;
    };
  }
  e.once = i;
  function s(k, v, C) {
    return h((b, E = null, M) => k((y) => b.call(E, v(y)), null, M), C);
  }
  e.map = s;
  function r(k, v, C) {
    return h((b, E = null, M) => k((y) => {
      v(y), b.call(E, y);
    }, null, M), C);
  }
  e.forEach = r;
  function n(k, v, C) {
    return h((b, E = null, M) => k((y) => v(y) && b.call(E, y), null, M), C);
  }
  e.filter = n;
  function o(k) {
    return k;
  ...
  function a(...k) {
    return (v, C = null, b) => {
      let E = vn(...k.map((M) => M((y) => v.call(C, y))));
      return c(E, b);
    };
  }
  e.any = a;
  function l(k, v, C, b) {
    let E = C;
    return s(k, (M) => (E = v(E, M), E), b);
  }
  e.reduce = l;
  function h(k, v) {
    let C, b = { onWillAddFirstListener() {
      C = k(E.fire, E);
  ...
  function c(k, v) {
    return v instanceof Array ? v.push(k) : v && v.add(k), k;
  }
  function d(k, v, C = 100, b = !1, E = !1, M, y) {
    let z, ne, ye, Ne = 0, Ce, ue = { leakWarningThreshold: M, onWillAddFirstListener() {
      z = k((ve) => {
        Ne++, ne = v(ne, ve), b && !ye && (xe.fire(ne), ne = void 0), Ce = () => {
          let Ve = ne;
          ne = void 0, ye = void 0, (!b || Ne > 1) && xe.fire(Ve), Ne = 0;
        }, typeof C == "number" ? (clearTimeout(ye), ye = setTimeout(Ce, C)) : ye === void 0 && (ye = 0, queueMicrotask(Ce));
      });
  ...
  e.debounce = d;
  function _(k, v = 0, C) {
    return e.debounce(k, (b, E) => b ? (b.push(E), b) : [E], v, void 0, !0, void 0, C);
  }
  e.accumulate = _;
  function f(k, v = (b, E) => b === E, C) {
    let b = !0, E;
    return n(k, (M) => {
      let y = b || !v(M, E);
      return b = !1, E = M, y;
  ...
  e.latch = f;
  function u(k, v, C) {
    return [e.filter(k, v, C), e.filter(k, (b) => !v(b), C)];
  }
  e.split = u;
  function p(k, v = !1, C = [], b) {
    let E = C.slice(), M = k((ne) => {
      E ? E.push(ne) : z.fire(ne);
    });
    b && b.add(M);
    let y = () => {
      E?.forEach((ne) => z.fire(ne)), E = null;
    }, z = new m({ onWillAddFirstListener() {
      M || (M = k((ne) => z.fire(ne)), b && b.add(M));
  ...
  e.chain = S;
  let x = /* @__PURE__ */ Symbol("HaltChainable");
  class H {
    constructor() {
      this.steps = [];
    }
    ...
    filter(v) {
      return this.steps.push((C) => v(C) ? C : x), this;
    }
    reduce(v, C) {
      let b = C;
    ...
    latch(v = (C, b) => C === b) {
      ...
      return this.steps.push((E) => {
        let M = C || !v(E, b);
        return C = !1, b = E, M ? E : x;
      }), this;
    }
    evaluate(v) {
      for (let C of this.steps) if (v = C(v), v === x) break;
      return v;
    }
  }
  function T(k, v, C = (b) => b) {
    let b = (...z) => y.fire(C(...z)), E = () => k.on(v, b), M = () => k.removeListener(v, b), y = new m({ onWillAddFirstListener: E, onDidRemoveLastListener: M });
    return y.event;
  }
  e.fromNodeEventEmitter = T;
  function B(k, v, C = (b) => b) {
    let b = (...z) => y.fire(C(...z)), E = () => k.addEventListener(v, b), M = () => k.removeEventListener(v, b), y = new m({ onWillAddFirstListener: E, onDidRemoveLastListener: M });
    return y.event;
  }
  e.fromDOMEventEmitter = B;
  function O(k) {
    return new Promise((v) => i(k)(v));
  }
  e.toPromise = O;
  function D(k) {
    let v = new m();
  ...
  class he {
    constructor(v, C) {
      ...
      this.emitter = new m(b), C && C.add(this.emitter);
    }
    beginUpdate(v) {
      this._counter++;
    }
  ...
  function Le(k, v) {
    return new he(k, v).emitter.event;
  }
  e.fromObservable = Le;
  function K(k) {
    return (v, C, b) => {
      let E = 0, M = !1, y = { beginUpdate() {
        E++;
      }, endUpdate() {
        E--, E === 0 && (k.reportChanges(), M && (M = !1, v.call(C)));
      ...
      return b instanceof qe ? b.add(z) : Array.isArray(b) && b.push(z), z;
    };
  }
...
bi.all = /* @__PURE__ */ new Set(), bi._idPool = 0;
var wn = bi, bn = -1, mr = class Sr {
  constructor(t, i, s = (Sr._idPool++).toString(16).padStart(3, "0")) {
...
`));
  ...
  constructor(e) {
    this.value = e, this.id = En++;
  }
}, Bn = 2, Dn, m = class {
  constructor(e) {
    this._size = 0, this._options = e, this._leakageMon = this._options?.leakWarningThreshold ? new yn(e?.onListenerError ?? Ot, this._options?.leakWarningThreshold ?? bn) : void 0, this._perfMon = this._options?._profName ? new wn(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue;
  }
  dispose() {
  ...
  get event() {
    return this._event ??= (e, t, i) => {
      if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
        ...
        console.warn(o);
        let a = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1], l = new kn(`${o}. HINT: Stack shows most frequent listener (${a[1]}-times)`, a[0]);
        return (this._options?.onListenerError || Ot)(l), P.None;
      }
      if (this._disposed) return P.None;
      t && (e = e.bind(t));
      let s = new ei(e), r;
      this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * 0.2) && (s.stack = Cn.create(), r = this._leakageMon.check(s.stack, this._size + 1)), this._listeners ? this._listeners instanceof ei ? (this._deliveryQueue ??= new Rn(), this._listeners = [this._listeners, s]) : this._listeners.push(s) : (this._options?.onWillAddFirstListener?.(this), this._listeners = s, this._options?.onDidAddFirstListener?.(this)), this._size++;
      let n = $(() => {
  ...
  _deliver(e, t) {
    if (!e) return;
    let i = this._options?.onListenerError || Ot;
    if (!i) {
      e.value(t);
      return;
    }
  ...
  fire(e) {
    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners) if (this._listeners instanceof ei) this._deliver(this._listeners, e);
    else {
...
Ji.INSTANCE.onDidChangeZoomLevel;
function Ln(e) {
  return Ji.INSTANCE.getZoomFactor(e);
}
Ji.INSTANCE.onDidChangeFullscreen;
var ot = typeof navigator == "object" ? navigator.userAgent : "", xi = ot.indexOf("Firefox") >= 0, Pn = ot.indexOf("AppleWebKit") >= 0, Zi = ot.indexOf("Chrome") >= 0, Tn = !Zi && ot.indexOf("Safari") >= 0;
ot.indexOf("Electron/") >= 0;
ot.indexOf("Android") >= 0;
var ti = !1;
if (typeof Ae.matchMedia == "function") {
  let e = Ae.matchMedia("(display-mode: standalone) or (display-mode: window-controls-overlay)"), t = Ae.matchMedia("(display-mode: fullscreen)");
  ti = e.matches, Mn(Ae, e, ({ matches: i }) => {
    ti && t.matches || (ti = i);
  });
}
var st = "en", ki = !1, Ei = !1, It = !1, br = !1, Dt, Nt = st, ds = st, An, Te, Je = globalThis, ge;
typeof Je.vscode < "u" && typeof Je.vscode.process < "u" ? ge = Je.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (ge = process);
var On = typeof ge?.versions?.electron == "string", In = On && ge?.type === "renderer";
if (typeof ge == "object") {
  ki = ge.platform === "win32", Ei = ge.platform === "darwin", It = ge.platform === "linux", It && ge.env.SNAP && ge.env.SNAP_REVISION, ge.env.CI || ge.env.BUILD_ARTIFACTSTAGINGDIRECTORY, Dt = st, Nt = st;
  let e = ge.env.VSCODE_NLS_CONFIG;
  if (e) try {
    let t = JSON.parse(e);
    Dt = t.userLocale, ds = t.osLocale, Nt = t.resolvedLanguage || st, An = t.languagePack?.translationsConfigFile;
  } catch {
  }
  br = !0;
} else typeof navigator == "object" && !In ? (Te = navigator.userAgent, ki = Te.indexOf("Windows") >= 0, Ei = Te.indexOf("Macintosh") >= 0, (Te.indexOf("Macintosh") >= 0 || Te.indexOf("iPad") >= 0 || Te.indexOf("iPhone") >= 0) && navigator.maxTouchPoints && navigator.maxTouchPoints > 0, It = Te.indexOf("Linux") >= 0, Te?.indexOf("Mobi") >= 0, Nt = globalThis._VSCODE_NLS_LANGUAGE || st, Dt = navigator.language.toLowerCase(), ds = Dt) : console.error("Unable to resolve platform.");
var yr = ki, Re = Ei, Nn = It, us = br, Me = Te, ze = Nt, Hn;
((e) => {
  function t() {
    return ze;
  }
...
var Wn = typeof Je.postMessage == "function" && !Je.importScripts;
(() => {
  if (Wn) {
    let e = [];
    Je.addEventListener("message", (i) => {
    ...
    return (i) => {
      let s = ++t;
      e.push({ id: s, callback: i }), Je.postMessage({ vscodeScheduleAsyncWork: s }, "*");
    };
  }
  return (e) => setTimeout(e);
})();
var zn = !!(Me && Me.indexOf("Chrome") >= 0);
Me && Me.indexOf("Firefox") >= 0;
!zn && Me && Me.indexOf("Safari") >= 0;
Me && Me.indexOf("Edg/") >= 0;
Me && Me.indexOf("Android") >= 0;
var tt = typeof navigator == "object" ? navigator : {};
us || document.queryCommandSupported && document.queryCommandSupported("copy") || tt && tt.clipboard && tt.clipboard.writeText, us || tt && tt.clipboard && tt.clipboard.readText;
var Qi = class {
  constructor() {
...
}, ii = new Qi(), _s = new Qi(), fs = new Qi(), Fn = new Array(230), Cr;
((e) => {
  function t(a) {
    return ii.keyCodeToStr(a);
  }
  e.toString = t;
  function i(a) {
    return ii.strToKeyCode(a);
  }
  e.fromString = i;
  function s(a) {
    return _s.keyCodeToStr(a);
  }
  e.toUserSettingsUS = s;
  function r(a) {
    return fs.keyCodeToStr(a);
  }
  e.toUserSettingsGeneral = r;
  function n(a) {
    return _s.strToKeyCode(a) || fs.strToKeyCode(a);
  }
...
var $n = class xr {
  ...
  equals(t) {
    return t instanceof xr && this.ctrlKey === t.ctrlKey && this.shiftKey === t.shiftKey && this.altKey === t.altKey && this.metaKey === t.metaKey && this.keyCode === t.keyCode;
  }
  getHashCode() {
...
function Un(e) {
  ...
  else if (Pn && (Re && t === 93 || !Re && t === 92))
    return 57;
  return Fn[t] || 0;
}
var qn = Re ? 256 : 2048, Vn = 512, Yn = 1024, Xn = Re ? 2048 : 256, ps = class {
  constructor(e) {
  ...
  _computeKeybinding() {
    ...
    let t = 0;
    return this.ctrlKey && (t |= qn), this.altKey && (t |= Vn), this.shiftKey && (t |= Yn), this.metaKey && (t |= Xn), t |= e, t;
  }
  _computeKeyCodeChord() {
    let e = 0;
    return this.keyCode !== 5 && this.keyCode !== 4 && this.keyCode !== 6 && this.keyCode !== 57 && (e = this.keyCode), new $n(this.ctrlKey, this.shiftKey, this.altKey, this.metaKey, e);
  }
...
var Gn = class {
  static getSameOriginWindowChain(e) {
    ...
    if (!t) {
      ...
      let i = e, s;
      do
        s = jn(i), s ? t.push({ window: new WeakRef(i), iframeElement: i.frameElement || null }) : t.push({ window: new WeakRef(i), iframeElement: null }), i = s;
      while (i);
    }
    return t.slice(0);
  }
  ...
  constructor(e, t) {
    ...
    let i = Gn.getPositionOfChildWindowRelativeToAncestorWindow(e, t.view);
  ...
  constructor(e, t = 0, i = 0) {
    ...
    if (e) {
      ...
      if (typeof r.wheelDeltaY < "u") s ? this.deltaY = r.wheelDeltaY / (120 * o) : this.deltaY = r.wheelDeltaY / 120;
        ...
        let a = e;
        a.deltaMode === a.DOM_DELTA_LINE ? xi && !Re ? this.deltaY = -e.deltaY / 3 : this.deltaY = -e.deltaY : this.deltaY = -e.deltaY / 40;
      }
      if (typeof r.wheelDeltaX < "u") Tn && yr ? this.deltaX = -(r.wheelDeltaX / 120) : s ? this.deltaX = r.wheelDeltaX / (120 * o) : this.deltaX = r.wheelDeltaX / 120;
      else if (typeof n.HORIZONTAL_AXIS < "u" && n.axis === n.HORIZONTAL_AXIS) this.deltaX = -e.detail / 3;
      else if (e.type === "wheel") {
        let a = e;
        a.deltaMode === a.DOM_DELTA_LINE ? xi && !Re ? this.deltaX = -e.deltaX / 3 : this.deltaX = -e.deltaX : this.deltaX = -e.deltaX / 40;
      }
...
((e) => {
  function t(i) {
    return i === e.None || i === e.Cancelled || i instanceof Zn ? !0 : !i || typeof i != "object" ? !1 : typeof i.isCancellationRequested == "boolean" && typeof i.onCancellationRequested == "function";
  }
  e.isCancellationToken = t, e.None = Object.freeze({ isCancellationRequested: !1, onCancellationRequested: oe.None }), e.Cancelled = Object.freeze({ isCancellationRequested: !0, onCancellationRequested: kr });
})(Jn ||= {});
var Zn = class {
  constructor() {
  ...
  cancelAndSet(e, t) {
    if (this._isDisposed) throw new mi("Calling 'cancelAndSet' on a disposed TimeoutTimer");
    this.cancel(), this._token = setTimeout(() => {
      this._token = -1, e();
    }, t);
  }
  setIfNotSet(e, t) {
    if (this._isDisposed) throw new mi("Calling 'setIfNotSet' on a disposed TimeoutTimer");
  ...
  cancelAndSet(e, t, i = globalThis) {
    if (this.isDisposed) throw new mi("Calling 'cancelAndSet' on a disposed IntervalTimer");
    this.cancel();
    let s = i.setInterval(() => {
      e();
    }, t);
...
ms.EMPTY = ms.fromArray([]);
var { getWindow: De, getWindowId: to, onDidRegisterWindow: io } = (function() {
  ...
  return { onDidRegisterWindow: i.event, onWillUnregisterWindow: r.event, onDidUnregisterWindow: s.event, registerWindow(o) {
    if (e.has(o.vscodeWindowId)) return P.None;
    let a = new qe(), l = { window: o, disposables: a.add(new qe()) };
    return e.set(o.vscodeWindowId, l), a.add($(() => {
      e.delete(o.vscodeWindowId), s.fire(o);
    })), a.add(R(o, ee.BEFORE_UNLOAD, () => {
      r.fire(o);
    })), i.fire(l), a;
  }, getWindows() {
    return e.values();
    ...
    let l = o;
    return l?.view ? l.view.window : Ae;
  }, getDocument(o) {
    return De(o).document;
  } };
})(), so = class {
  constructor(e, t, i, s) {
...
function R(e, t, i, s) {
  return new so(e, t, i, s);
}
var Ss = function(e, t, i, s) {
  return R(e, t, i, s);
}, ts, ro = class extends Qn {
  constructor(e) {
    super(), this.defaultTarget = e && De(e);
  }
  cancelAndSet(e, t, i) {
...
(function() {
  let e = /* @__PURE__ */ new Map(), t = /* @__PURE__ */ new Map(), i = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map(), r = (n) => {
    i.set(n, !1);
    let o = e.get(n) ?? [];
    for (t.set(n, o), e.set(n, []), s.set(n, !0); o.length > 0; ) o.sort(ws.sort), o.shift().execute();
    s.set(n, !1);
  };
  ts = (n, o, a = 0) => {
    let l = to(n), h = new ws(o, a), c = e.get(l);
    return c || (c = [], e.set(l, c)), c.push(h), i.get(l) || (i.set(l, !0), n.requestAnimationFrame(() => r(l))), h;
  };
})();
function no(e) {
  let t = e.getBoundingClientRect(), i = De(e);
  return { left: t.left + i.scrollX, top: t.top + i.scrollY, width: t.width, height: t.height };
}
var ee = { CLICK: "click", MOUSE_DOWN: "mousedown", MOUSE_OVER: "mouseover", MOUSE_LEAVE: "mouseleave", MOUSE_WHEEL: "wheel", POINTER_UP: "pointerup", POINTER_DOWN: "pointerdown", POINTER_MOVE: "pointermove", KEY_DOWN: "keydown", KEY_UP: "keyup", BEFORE_UNLOAD: "beforeunload", CHANGE: "change", FOCUS: "focus", BLUR: "blur", INPUT: "input" }, oo = class {
  constructor(e) {
...
var Er = class {
  constructor() {
    this._hooks = new qe(), this._pointerMoveCallback = null, this._onStopCallback = null;
  }
  dispose() {
  ...
  startMonitoring(e, t, i, s, r) {
    ...
    this._hooks.add(R(n, ee.POINTER_MOVE, (o) => {
      if (o.buttons !== i) {
        this.stopMonitoring(!0);
        return;
      }
      o.preventDefault(), this._pointerMoveCallback(o);
    })), this._hooks.add(R(n, ee.POINTER_UP, (o) => this.stopMonitoring(!0)));
  }
};
function ao(e, t, i) {
  let s = null, r = null;
...
var Be;
((e) => (e.Tap = "-xterm-gesturetap", e.Change = "-xterm-gesturechange", e.Start = "-xterm-gesturestart", e.End = "-xterm-gesturesend", e.Contextmenu = "-xterm-gesturecontextmenu"))(Be ||= {});
var ft = class ae extends P {
  constructor() {
    super(), this.dispatched = !1, this.targets = new cs(), this.ignoreTargets = new cs(), this.activeTouches = {}, this.handle = null, this._lastSetTapCountTime = 0, this._register(oe.runAndSubscribe(io, ({ window: t, disposables: i }) => {
  ...
  static addTarget(t) {
    if (!ae.isTouchDevice()) return P.None;
  ...
  onTouchStart(t) {
    ...
    for (let s = 0, r = t.targetTouches.length; s < r; s++) {
      ...
      let o = this.newGestureEvent(Be.Start, n.target);
  ...
  onTouchEnd(t, i) {
    ...
    for (let n = 0, o = i.changedTouches.length; n < o; n++) {
      ...
      if (h < ae.HOLD_DELAY && Math.abs(l.initialPageX - fe(l.rollingPageX)) < 30 && Math.abs(l.initialPageY - fe(l.rollingPageY)) < 30) {
        let c = this.newGestureEvent(Be.Tap, l.initialTarget);
        c.pageX = fe(l.rollingPageX), c.pageY = fe(l.rollingPageY), this.dispatchEvent(c);
      } else if (h >= ae.HOLD_DELAY && Math.abs(l.initialPageX - fe(l.rollingPageX)) < 30 && Math.abs(l.initialPageY - fe(l.rollingPageY)) < 30) {
        let c = this.newGestureEvent(Be.Contextmenu, l.initialTarget);
        c.pageX = fe(l.rollingPageX), c.pageY = fe(l.rollingPageY), this.dispatchEvent(c);
      } else if (r === 1) {
        let c = fe(l.rollingPageX), d = fe(l.rollingPageY), _ = fe(l.rollingTimestamps) - l.rollingTimestamps[0], f = c - l.rollingPageX[0], u = d - l.rollingPageY[0], p = [...this.targets].filter((S) => l.initialTarget instanceof Node && S.contains(l.initialTarget));
        this.inertia(t, p, s, Math.abs(f) / _, f > 0 ? 1 : -1, c, Math.abs(u) / _, u > 0 ? 1 : -1, d);
      }
      this.dispatchEvent(this.newGestureEvent(Be.End, l.initialTarget)), delete this.activeTouches[a.identifier];
    }
  ...
  dispatchEvent(t) {
    ...
    } else (t.type === Be.Change || t.type === Be.Contextmenu) && (this._lastSetTapCountTime = 0);
  ...
  inertia(t, i, s, r, n, o, a, l, h) {
    this.handle = ts(t, () => {
      let c = Date.now(), d = c - s, _ = 0, f = 0, u = !0;
      r += ae.SCROLL_FRICTION * d, a += ae.SCROLL_FRICTION * d, r > 0 && (u = !1, _ = n * r * d), a > 0 && (u = !1, f = l * a * d);
      let p = this.newGestureEvent(Be.Change);
      p.translationX = _, p.translationY = f, i.forEach((S) => S.dispatchEvent(p)), u || this.inertia(t, i, c, r, n, o + _, a, l, h + f);
    });
  }
  onTouchMove(t) {
    let i = Date.now();
    for (let s = 0, r = t.changedTouches.length; s < r; s++) {
      ...
      let o = this.activeTouches[n.identifier], a = this.newGestureEvent(Be.Change, o.initialTarget);
...
ft.SCROLL_FRICTION = -5e-3, ft.HOLD_DELAY = 700, ft.CLEAR_TAP_COUNT_TIME = 400, Y([ao], ft, "isTouchDevice", 1);
var ho = ft, is = class extends P {
  onclick(e, t) {
    this._register(R(e, ee.CLICK, (i) => t(new Rt(De(e), i))));
  }
  onmousedown(e, t) {
    this._register(R(e, ee.MOUSE_DOWN, (i) => t(new Rt(De(e), i))));
  }
  onmouseover(e, t) {
    this._register(R(e, ee.MOUSE_OVER, (i) => t(new Rt(De(e), i))));
  }
  onmouseleave(e, t) {
    this._register(R(e, ee.MOUSE_LEAVE, (i) => t(new Rt(De(e), i))));
  }
  onkeydown(e, t) {
    this._register(R(e, ee.KEY_DOWN, (i) => t(new ps(i))));
  }
  onkeyup(e, t) {
    this._register(R(e, ee.KEY_UP, (i) => t(new ps(i))));
  }
  oninput(e, t) {
    this._register(R(e, ee.INPUT, t));
  }
  onblur(e, t) {
    this._register(R(e, ee.BLUR, t));
  }
  onfocus(e, t) {
    this._register(R(e, ee.FOCUS, t));
  }
  onchange(e, t) {
    this._register(R(e, ee.CHANGE, t));
  }
  ignoreGesture(e) {
    return ho.ignoreTarget(e);
  }
}, bs = 11, lo = class extends is {
  constructor(e) {
    super(), this._onActivate = e.onActivate, this.bgDomNode = document.createElement("div"), this.bgDomNode.className = "arrow-background", this.bgDomNode.style.position = "absolute", this.bgDomNode.style.width = e.bgWidth + "px", this.bgDomNode.style.height = e.bgHeight + "px", typeof e.top < "u" && (this.bgDomNode.style.top = "0px"), typeof e.left < "u" && (this.bgDomNode.style.left = "0px"), typeof e.bottom < "u" && (this.bgDomNode.style.bottom = "0px"), typeof e.right < "u" && (this.bgDomNode.style.right = "0px"), this.domNode = document.createElement("div"), this.domNode.className = e.className, this.domNode.style.position = "absolute", this.domNode.style.width = bs + "px", this.domNode.style.height = bs + "px", typeof e.top < "u" && (this.domNode.style.top = e.top + "px"), typeof e.left < "u" && (this.domNode.style.left = e.left + "px"), typeof e.bottom < "u" && (this.domNode.style.bottom = e.bottom + "px"), typeof e.right < "u" && (this.domNode.style.right = e.right + "px"), this._pointerMoveMonitor = this._register(new Er()), this._register(Ss(this.bgDomNode, ee.POINTER_DOWN, (t) => this._arrowPointerDown(t))), this._register(Ss(this.domNode, ee.POINTER_DOWN, (t) => this._arrowPointerDown(t))), this._pointerdownRepeatTimer = this._register(new ro()), this._pointerdownScheduleRepeatTimer = this._register(new es());
  }
  _arrowPointerDown(e) {
    if (!e.target || !(e.target instanceof Element)) return;
    let t = () => {
      this._pointerdownRepeatTimer.cancelAndSet(() => this._onActivate(), 1e3 / 24, De(e));
    };
  ...
  withScrollDimensions(t, i) {
    return new Bi(this._forceIntegerValues, typeof t.width < "u" ? t.width : this.width, typeof t.scrollWidth < "u" ? t.scrollWidth : this.scrollWidth, i ? this.rawScrollLeft : this.scrollLeft, typeof t.height < "u" ? t.height : this.height, typeof t.scrollHeight < "u" ? t.scrollHeight : this.scrollHeight, i ? this.rawScrollTop : this.scrollTop);
  }
  withScrollPosition(t) {
    return new Bi(this._forceIntegerValues, this.width, this.scrollWidth, typeof t.scrollLeft < "u" ? t.scrollLeft : this.rawScrollLeft, this.height, this.scrollHeight, typeof t.scrollTop < "u" ? t.scrollTop : this.rawScrollTop);
  }
  createScrollEvent(t, i) {
    let s = this.width !== t.width, r = this.scrollWidth !== t.scrollWidth, n = this.scrollLeft !== t.scrollLeft, o = this.height !== t.height, a = this.scrollHeight !== t.scrollHeight, l = this.scrollTop !== t.scrollTop;
  ...
  constructor(e) {
    super(), this._scrollableBrand = void 0, this._onScroll = this._register(new m()), this.onScroll = this._onScroll.event, this._smoothScrollDuration = e.smoothScrollDuration, this._scheduleAtNextAnimationFrame = e.scheduleAtNextAnimationFrame, this._state = new co(e.forceIntegerValues, 0, 0, 0, 0, 0, 0), this._smoothScrolling = null;
  }
  dispose() {
  ...
  setScrollPositionSmooth(e, t) {
    ...
    if (this._smoothScrolling) {
      ...
      let s;
      t ? s = new Cs(this._smoothScrolling.from, i, this._smoothScrolling.startTime, this._smoothScrolling.duration) : s = this._smoothScrolling.combine(this._state, i, this._smoothScrollDuration), this._smoothScrolling.dispose(), this._smoothScrolling = s;
    } else {
      let i = this._state.withScrollPosition(e);
      this._smoothScrolling = Cs.start(this._state, i, this._smoothScrollDuration);
    }
...
var Cs = class Di {
  ...
  _initAnimation(t, i, s) {
    if (Math.abs(t - i) > 2.5 * s) {
      let r, n;
      return t < i ? (r = t + 0.75 * s, n = i - 0.75 * s) : (r = t - 0.75 * s, n = i + 0.75 * s), _o(si(t, r), si(n, i), 0.33);
    }
    return si(t, i);
  }
  dispose() {
  ...
  _tick(t) {
    ...
    return new ys(this.to.scrollLeft, this.to.scrollTop, !0);
  }
  combine(t, i, s) {
    return Di.start(t, i, s);
  }
  static start(t, i, s) {
    s = s + 10;
    let r = Date.now() - 10;
    return new Di(t, i, r, s);
  }
};
function fo(e) {
  return Math.pow(e, 3);
...
var go = class extends P {
  constructor(e, t, i) {
    super(), this._visibility = e, this._visibleClassName = t, this._invisibleClassName = i, this._domNode = null, this._isVisible = !1, this._isNeeded = !1, this._rawShouldBeVisible = !1, this._shouldBeVisible = !1, this._revealTimer = this._register(new es());
  }
  setVisibility(e) {
...
}, vo = 140, Br = class extends is {
  constructor(e) {
    super(), this._lazyRender = e.lazyRender, this._host = e.host, this._scrollable = e.scrollable, this._scrollByPage = e.scrollByPage, this._scrollbarState = e.scrollbarState, this._visibilityController = this._register(new go(e.visibility, "visible scrollbar " + e.extraScrollbarClassName, "invisible scrollbar " + e.extraScrollbarClassName)), this._visibilityController.setIsNeeded(this._scrollbarState.isNeeded()), this._pointerMoveMonitor = this._register(new Er()), this._shouldRender = !0, this.domNode = St(document.createElement("div")), this.domNode.setAttribute("role", "presentation"), this.domNode.setAttribute("aria-hidden", "true"), this._visibilityController.setDomNode(this.domNode), this.domNode.setPosition("absolute"), this._register(R(this.domNode.domNode, ee.POINTER_DOWN, (t) => this._domNodePointerDown(t)));
  }
  _createArrow(e) {
    let t = this._register(new lo(e));
    this.domNode.domNode.appendChild(t.bgDomNode), this.domNode.domNode.appendChild(t.domNode);
  }
  _createSlider(e, t, i, s) {
    this.slider = St(document.createElement("div")), this.slider.setClassName("slider"), this.slider.setPosition("absolute"), this.slider.setTop(e), this.slider.setLeft(t), typeof i == "number" && this.slider.setWidth(i), typeof s == "number" && this.slider.setHeight(s), this.slider.setLayerHinting(!0), this.slider.setContain("strict"), this.domNode.domNode.appendChild(this.slider.domNode), this._register(R(this.slider.domNode, ee.POINTER_DOWN, (r) => {
  ...
  clone() {
    return new Ri(this._arrowSize, this._scrollbarSize, this._oppositeScrollbarSize, this._visibleSize, this._scrollSize, this._scrollPosition);
  }
  setVisibleSize(t) {
    let i = Math.round(t);
  ...
  static _computeValues(t, i, s, r, n) {
    let o = Math.max(0, s - t), a = Math.max(0, o - 2 * i), l = r > 0 && r > s;
  ...
  _refreshComputedValues() {
    let t = Ri._computeValues(this._oppositeScrollbarSize, this._arrowSize, this._visibleSize, this._scrollSize, this._scrollPosition);
  ...
  _computeScore(t, i) {
    ...
    if ((!this._isAlmostInt(t.deltaX) || !this._isAlmostInt(t.deltaY)) && (s += 0.25), i) {
      let r = Math.abs(t.deltaX), n = Math.abs(t.deltaY), o = Math.abs(i.deltaX), a = Math.abs(i.deltaY), l = Math.max(Math.min(r, o), 1), h = Math.max(Math.min(n, a), 1), c = Math.max(r, o), d = Math.max(n, a);
      c % l === 0 && d % h === 0 && (s -= 0.5);
    }
...
Mi.INSTANCE = new Mi();
var yo = Mi, Co = class extends is {
  constructor(e, t, i) {
    super(), this._onScroll = this._register(new m()), this.onScroll = this._onScroll.event, this._onWillScroll = this._register(new m()), this.onWillScroll = this._onWillScroll.event, this._options = ko(t), this._scrollable = i, this._register(this._scrollable.onScroll((r) => {
  ...
  updateClassName(e) {
    this._options.className = e, Re && (this._options.className += " mac"), this._domNode.className = "xterm-scrollable-element " + this._options.className;
  }
  updateOptions(e) {
  ...
  delegateScrollFromMouseWheelEvent(e) {
    this._onMouseWheel(new vs(e));
  }
  _setListeningToMouseWheel(e) {
    if (this._mouseWheelToDispose.length > 0 !== e && (this._mouseWheelToDispose = Ze(this._mouseWheelToDispose), e)) {
      let t = (i) => {
        this._onMouseWheel(new vs(i));
      };
      this._mouseWheelToDispose.push(R(this._listenOnDomNode, ee.MOUSE_WHEEL, t, { passive: !1 }));
    }
  }
  _onMouseWheel(e) {
    ...
    if (e.deltaY || e.deltaX) {
      ...
      let o = !Re && e.browserEvent && e.browserEvent.shiftKey;
      ...
      let a = this._scrollable.getFutureScrollPosition(), l = {};
      if (r) {
        let h = xs * r, c = a.scrollTop - (h < 0 ? Math.floor(h) : Math.ceil(h));
        this._verticalScrollbar.writeScrollPosition(l, c);
      }
      if (n) {
        let h = xs * n, c = a.scrollLeft - (h < 0 ? Math.floor(h) : Math.ceil(h));
        this._horizontalScrollbar.writeScrollPosition(l, c);
      }
      l = this._scrollable.validateScrollPosition(l), (a.scrollLeft !== l.scrollLeft || a.scrollTop !== l.scrollTop) && (this._options.mouseWheelSmoothScroll && t.isPhysicalMouseWheel() ? this._scrollable.setScrollPositionSmooth(l) : this._scrollable.setScrollPositionNow(l), i = !0);
    }
    let s = i;
  ...
  _scheduleHide() {
    !this._mouseIsOver && !this._isDragging && this._hideTimeout.cancelAndSet(() => this._hide(), wo);
  }
}, xo = class extends Co {
  constructor(e, t, i) {
    super(e, t, i);
...
var Li = class extends P {
  constructor(e, t, i, s, r, n, o, a) {
    ...
    let l = this._register(new uo({ forceIntegerValues: !1, smoothScrollDuration: this._optionsService.rawOptions.smoothScrollDuration, scheduleAtNextAnimationFrame: (h) => ts(s.window, h) }));
    ...
    })), this._scrollableElement = this._register(new xo(t, { vertical: 1, horizontal: 2, useShadows: !1, mouseWheelSmoothScroll: !0, ...this._getChangeOptions() }, l)), this._register(this._optionsService.onMultipleOptionChange(["scrollSensitivity", "fastScrollSensitivity", "overviewRuler"], () => this._scrollableElement.updateOptions(this._getChangeOptions()))), this._register(r.onProtocolChange((h) => {
...
Li = Y([w(2, ce), w(3, Oe), w(4, hr), w(5, nt), w(6, de), w(7, Ie)], Li);
...
Pi = Y([w(1, ce), w(2, Oe), w(3, xt), w(4, Ie)], Pi);
var Eo = class {
  constructor() {
  ...
  _refreshDrawConstants() {
    ...
    Fe.full = this._canvas.width, Fe.left = e, Fe.center = t, Fe.right = e, this._refreshDrawHeightConstants(), ht.full = 1, ht.left = 1, ht.center = 1 + Fe.left, ht.right = 1 + Fe.left + Fe.center;
  }
  _refreshDrawHeightConstants() {
    ke.full = Math.round(2 * this._coreBrowserService.dpr);
    ...
    ke.left = t, ke.center = t, ke.right = t;
  }
  _refreshColorZonePadding() {
    this._colorZoneStore.setPadding({ full: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * ke.full), left: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * ke.left), center: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * ke.center), right: Math.floor(this._bufferService.buffers.active.lines.length / (this._canvas.height - 1) * ke.right) }), this._lastKnownBufferLength = this._bufferService.buffers.normal.lines.length;
  }
  ...
  _renderColorZone(e) {
    this._ctx.fillStyle = e.color, this._ctx.fillRect(ht[e.position || "full"], Math.round((this._canvas.height - 1) * (e.startBufferLine / this._bufferService.buffers.active.lines.length) - ke[e.position || "full"] / 2), Fe[e.position || "full"], Math.round((this._canvas.height - 1) * ((e.endBufferLine - e.startBufferLine) / this._bufferService.buffers.active.lines.length) + ke[e.position || "full"]));
  }
  _queueRefresh(e, t) {
...
$t = Y([w(2, ce), w(3, xt), w(4, Ie), w(5, de), w(6, nt), w(7, Oe)], $t);
var g;
...
var Ht;
((e) => (e.PAD = "", e.HOP = "", e.BPH = "", e.NBH = "", e.IND = "", e.NEL = "", e.SSA = "", e.ESA = "", e.HTS = "", e.HTJ = "", e.VTS = "", e.PLD = "", e.PLU = "", e.RI = "", e.SS2 = "", e.SS3 = "", e.DCS = "", e.PU1 = "", e.PU2 = "", e.STS = "", e.CCH = "", e.MW = "", e.SPA = "", e.EPA = "", e.SOS = "", e.SGCI = "", e.SCI = "", e.CSI = "", e.ST = "", e.OSC = "", e.PM = "", e.APC = ""))(Ht ||= {});
var Rr;
((e) => e.ST = `${g.ESC}\\`)(Rr ||= {});
var Ti = class {
  ...
  _handleAnyTextareaChanges() {
    ...
    setTimeout(() => {
      if (!this._isComposing) {
        ...
        this._dataAlreadySent = i, t.length > e.length ? this._coreService.triggerDataEvent(i, !0) : t.length < e.length ? this._coreService.triggerDataEvent(`${g.DEL}`, !0) : t.length === e.length && t !== e && this._coreService.triggerDataEvent(t, !0);
      }
    }, 0);
  }
...
Ti = Y([w(2, ce), w(3, de), w(4, et), w(5, Ie)], Ti);
var te = 0, ie = 0, se = 0, V = 0, ks = { css: "#00000000", rgba: 0 }, G;
((e) => {
  function t(r, n, o, a) {
    return a !== void 0 ? `#${Ye(r)}${Ye(n)}${Ye(o)}${Ye(a)}` : `#${Ye(r)}${Ye(n)}${Ye(o)}`;
  }
  e.toCss = t;
...
((e) => {
  function t(l, h) {
    if (V = (h.rgba & 255) / 255, V === 1) return { css: h.css, rgba: h.rgba };
    let c = h.rgba >> 24 & 255, d = h.rgba >> 16 & 255, _ = h.rgba >> 8 & 255, f = l.rgba >> 24 & 255, u = l.rgba >> 16 & 255, p = l.rgba >> 8 & 255;
    te = f + Math.round((c - f) * V), ie = u + Math.round((d - u) * V), se = p + Math.round((_ - p) * V);
    let S = G.toCss(te, ie, se), x = G.toRgba(te, ie, se);
    return { css: S, rgba: x };
  }
  e.blend = t;
  function i(l) {
  ...
  e.isOpaque = i;
  function s(l, h, c) {
    let d = Wt.ensureContrastRatio(l.rgba, h.rgba, c);
    if (d) return G.toColor(d >> 24 & 255, d >> 16 & 255, d >> 8 & 255);
  }
  e.ensureContrastRatio = s;
  function r(l) {
    let h = (l.rgba | 255) >>> 0;
    return [te, ie, se] = Wt.toChannels(h), { css: G.toCss(te, ie, se), rgba: h };
  }
  e.opaque = r;
  function n(l, h) {
    return V = Math.round(h * 255), [te, ie, se] = Wt.toChannels(l.rgba), { css: G.toCss(te, ie, se, V), rgba: G.toRgba(te, ie, se, V) };
  }
  e.opacity = n;
  function o(l, h) {
    return V = l.rgba & 255, n(l, V * h / 255);
  }
  e.multiplyOpacity = o;
  function a(l) {
...
((e) => {
  ...
  function s(r) {
    if (r.match(/#[\da-f]{3,8}/i)) switch (r.length) {
      ...
      case 5:
        return te = parseInt(r.slice(1, 2).repeat(2), 16), ie = parseInt(r.slice(2, 3).repeat(2), 16), se = parseInt(r.slice(3, 4).repeat(2), 16), V = parseInt(r.slice(4, 5).repeat(2), 16), G.toColor(te, ie, se, V);
      case 7:
    ...
    if (n) return te = parseInt(n[1]), ie = parseInt(n[2]), se = parseInt(n[3]), V = Math.round((n[5] === void 0 ? 1 : parseFloat(n[5])) * 255), G.toColor(te, ie, se, V);
    ...
    if (t.fillRect(0, 0, 1, 1), [te, ie, se, V] = t.getImageData(0, 0, 1, 1).data, V !== 255) throw new Error("css.toColor: Unsupported css format");
    return { rgba: G.toRgba(te, ie, se, V), css: r };
  }
  e.toColor = s;
})(q ||= {});
var le;
...
((e) => {
  function t(o, a) {
    if (V = (a & 255) / 255, V === 1) return a;
    let l = a >> 24 & 255, h = a >> 16 & 255, c = a >> 8 & 255, d = o >> 24 & 255, _ = o >> 16 & 255, f = o >> 8 & 255;
    return te = d + Math.round((l - d) * V), ie = _ + Math.round((h - _) * V), se = f + Math.round((c - f) * V), G.toRgba(te, ie, se);
  }
  e.blend = t;
  function i(o, a, l) {
    let h = le.relativeLuminance(o >> 8), c = le.relativeLuminance(a >> 8);
    if (Pe(h, c) < l) {
      if (c < h) {
        let f = s(o, a, l), u = Pe(h, le.relativeLuminance(f >> 8));
        if (u < l) {
          let p = r(o, a, l), S = Pe(h, le.relativeLuminance(p >> 8));
          return u > S ? f : p;
        }
        return f;
      }
      let d = r(o, a, l), _ = Pe(h, le.relativeLuminance(d >> 8));
      if (_ < l) {
        let f = s(o, a, l), u = Pe(h, le.relativeLuminance(f >> 8));
        return _ > u ? d : f;
      }
  ...
  function s(o, a, l) {
    let h = o >> 24 & 255, c = o >> 16 & 255, d = o >> 8 & 255, _ = a >> 24 & 255, f = a >> 16 & 255, u = a >> 8 & 255, p = Pe(le.relativeLuminance2(_, f, u), le.relativeLuminance2(h, c, d));
    for (; p < l && (_ > 0 || f > 0 || u > 0); ) _ -= Math.max(0, Math.ceil(_ * 0.1)), f -= Math.max(0, Math.ceil(f * 0.1)), u -= Math.max(0, Math.ceil(u * 0.1)), p = Pe(le.relativeLuminance2(_, f, u), le.relativeLuminance2(h, c, d));
    return (_ << 24 | f << 16 | u << 8 | 255) >>> 0;
  }
  e.reduceLuminance = s;
  function r(o, a, l) {
    let h = o >> 24 & 255, c = o >> 16 & 255, d = o >> 8 & 255, _ = a >> 24 & 255, f = a >> 16 & 255, u = a >> 8 & 255, p = Pe(le.relativeLuminance2(_, f, u), le.relativeLuminance2(h, c, d));
    for (; p < l && (_ < 255 || f < 255 || u < 255); ) _ = Math.min(255, _ + Math.ceil((255 - _) * 0.1)), f = Math.min(255, f + Math.ceil((255 - f) * 0.1)), u = Math.min(255, u + Math.ceil((255 - u) * 0.1)), p = Pe(le.relativeLuminance2(_, f, u), le.relativeLuminance2(h, c, d));
    return (_ << 24 | f << 16 | u << 8 | 255) >>> 0;
  }
...
var Bo = class extends Ct {
  ...
  getJoinedCharacters(e) {
    ...
    let i = [], s = t.translateToString(!0), r = 0, n = 0, o = 0, a = t.getFg(0), l = t.getBg(0);
    for (let h = 0; h < t.getTrimmedLength(); h++) if (t.loadCell(h, this._workCell), this._workCell.getWidth() !== 0) {
      if (this._workCell.fg !== a || this._workCell.bg !== l) {
        if (h - r > 1) {
          let c = this._getJoinedRanges(s, o, n, t, r);
    ...
    if (this._bufferService.cols - r > 1) {
      let h = this._getJoinedRanges(s, o, n, t, r);
  ...
  _getJoinedRanges(e, t, i, s, r) {
    ...
    for (let a = 1; a < this._characterJoiners.length; a++) try {
      ...
      for (let h = 0; h < l.length; h++) Kt._mergeRanges(o, l[h]);
    } catch (l) {
      console.error(l);
    }
  ...
  _stringRangesToCellRanges(e, t, i) {
    ...
    if (o) {
      for (let a = i; a < this._bufferService.cols; a++) {
        let l = t.getWidth(a), h = t.getString(a).length || Ue.length;
        if (l !== 0) {
...
function Lo() {
  return { css: { canvas: Mt(), cell: Mt() }, device: { canvas: Mt(), cell: Mt(), char: { width: 0, height: 0, left: 0, top: 0 } } };
}
function Mt() {
...
var Ai = class {
  ...
  createRow(e, t, i, s, r, n, o, a, l, h, c) {
    let d = [], _ = this._characterJoinerService.getJoinedCharacters(t), f = this._themeService.colors, u = e.getNoBgTrimmedLength();
    i && u < n + 1 && (u = n + 1);
    let p, S = 0, x = "", H = 0, T = 0, B = 0, O = 0, D = !1, A = 0, W = !1, he = 0, Le = 0, K = [], k = h !== -1 && c !== -1;
    for (let v = 0; v < u; v++) {
      e.loadCell(v, this._workCell);
      let C = this._workCell.getWidth();
      if (C === 0) continue;
      let b = !1, E = v >= Le, M = v, y = this._workCell;
      if (_.length > 0 && v === _[0][0] && E) {
        let I = _.shift(), Zt = this._isCellInSelection(I[0], t);
        for (H = I[0] + 1; H < I[1]; H++) E &&= Zt === this._isCellInSelection(H, t);
        E &&= !i || n < I[0] || n >= I[1], E ? (b = !0, y = new Bo(this._workCell, e.translateToString(!0, I[0], I[1]), I[1] - I[0]), M = I[1] - 1, C = y.getWidth()) : Le = I[1];
      }
      let z = this._isCellInSelection(v, t), ne = i && v === n, ye = k && v >= h && v <= c, Ne = !1;
      this._decorationService.forEachDecorationAtCell(v, t, void 0, (I) => {
        Ne = !0;
      });
      let Ce = y.getChars() || Ue;
      if (Ce === " " && (y.isUnderline() || y.isOverline()) && (Ce = " "), he = C * a - l.get(Ce, y.isBold(), y.isItalic()), !p) p = this._document.createElement("span");
      else if (S && (z && W || !z && !W && y.bg === T) && (z && W && f.selectionForeground || y.fg === B) && y.extended.ext === O && ye === D && he === A && !ne && !b && !Ne && E) {
        y.isInvisible() ? x += Ue : x += Ce, S++;
        continue;
      } else S && (p.textContent = x), p = this._document.createElement("span"), S = 0, x = "";
      if (T = y.bg, B = y.fg, O = y.extended.ext, D = ye, A = he, W = z, b && n >= v && n <= M && (n = v), !this._coreService.isCursorHidden && ne && this._coreService.isCursorInitialized) {
        if (K.push("xterm-cursor"), this._coreBrowserService.isFocused) o && K.push("xterm-cursor-blink"), K.push(s === "bar" ? "xterm-cursor-bar" : s === "underline" ? "xterm-cursor-underline" : "xterm-cursor-block");
        else if (r) switch (r) {
          case "outline":
      ...
      if (y.isBold() && K.push("xterm-bold"), y.isItalic() && K.push("xterm-italic"), y.isDim() && K.push("xterm-dim"), y.isInvisible() ? x = Ue : x = y.getChars() || Ue, y.isUnderline() && (K.push(`xterm-underline-${y.extended.underlineStyle}`), x === " " && (x = " "), !y.isUnderlineColorDefault())) if (y.isUnderlineColorRGB()) p.style.textDecorationColor = `rgb(${Ct.toColorRGB(y.getUnderlineColor()).join(",")})`;
      else {
        let I = y.getUnderlineColor();
        this._optionsService.rawOptions.drawBoldTextInBrightColors && y.isBold() && I < 8 && (I += 8), p.style.textDecorationColor = f.ansi[I].css;
      }
      y.isOverline() && (K.push("xterm-overline"), x === " " && (x = " ")), y.isStrikethrough() && K.push("xterm-strikethrough"), ye && (p.style.textDecoration = "underline");
      let ue = y.getFgColor(), xe = y.getFgColorMode(), ve = y.getBgColor(), Ve = y.getBgColorMode(), Jt = !!y.isInverse();
      if (Jt) {
        let I = ue;
        ue = ve, ve = I;
        let Zt = xe;
      ...
      let He, Bt, at = !1;
      this._decorationService.forEachDecorationAtCell(v, t, void 0, (I) => {
        I.options.layer !== "top" && at || (I.backgroundColorRGB && (Ve = 50331648, ve = I.backgroundColorRGB.rgba >> 8 & 16777215, He = I.backgroundColorRGB), I.foregroundColorRGB && (xe = 50331648, ue = I.foregroundColorRGB.rgba >> 8 & 16777215, Bt = I.foregroundColorRGB), at = I.options.layer === "top");
      }), !at && z && (He = this._coreBrowserService.isFocused ? f.selectionBackgroundOpaque : f.selectionInactiveBackgroundOpaque, ve = He.rgba >> 8 & 16777215, Ve = 50331648, at = !0, f.selectionForeground && (xe = 50331648, ue = f.selectionForeground.rgba >> 8 & 16777215, Bt = f.selectionForeground)), at && K.push("xterm-decoration-top");
      let We;
      switch (Ve) {
        case 16777216:
        case 33554432:
          We = f.ansi[ve], K.push(`xterm-bg-${ve}`);
          break;
        case 50331648:
          We = G.toColor(ve >> 16, ve >> 8 & 255, ve & 255), this._addStyle(p, `background-color:#${Es((ve >>> 0).toString(16), "0", 6)}`);
          break;
        default:
          Jt ? (We = f.foreground, K.push("xterm-bg-257")) : We = f.background;
      }
      switch (He || y.isDim() && (He = F.multiplyOpacity(We, 0.5)), xe) {
        case 16777216:
        case 33554432:
          y.isBold() && ue < 8 && this._optionsService.rawOptions.drawBoldTextInBrightColors && (ue += 8), this._applyMinimumContrast(p, We, f.ansi[ue], y, He, void 0) || K.push(`xterm-fg-${ue}`);
          break;
        case 50331648:
          let I = G.toColor(ue >> 16 & 255, ue >> 8 & 255, ue & 255);
          this._applyMinimumContrast(p, We, I, y, He, Bt) || this._addStyle(p, `color:#${Es(ue.toString(16), "0", 6)}`);
          break;
        default:
          this._applyMinimumContrast(p, We, f.foreground, y, He, Bt) || Jt && K.push("xterm-fg-257");
      }
      K.length && (p.className = K.join(" "), K.length = 0), !ne && !b && !Ne && E ? S++ : p.textContent = x, he !== this.defaultSpacing && (p.style.letterSpacing = `${he}px`), d.push(p), v = M;
    }
    return p && S && (p.textContent = x), d;
  }
  _applyMinimumContrast(e, t, i, s, r, n) {
    if (this._optionsService.rawOptions.minimumContrastRatio === 1 || Mo(s.getCode())) return !1;
    ...
    if (!r && !n && (a = o.getColor(t.rgba, i.rgba)), a === void 0) {
      ...
      a = F.ensureContrastRatio(r || t, n || i, l), o.setColor((r || t).rgba, (n || i).rgba, a ?? null);
    }
...
Ai = Y([w(1, dr), w(2, de), w(3, Oe), w(4, et), w(5, xt), w(6, nt)], Ai);
function Es(e, t, i) {
...
var Po = class {
  ...
  update(e, t, i, s = !1) {
    ...
    let r = e.buffers.active.ydisp, n = t[1] - r, o = i[1] - r, a = Math.max(n, 0), l = Math.min(o, e.rows - 1);
    if (a >= e.rows || l < 0) {
      this.clear();
      return;
    }
    this.hasSelection = !0, this.columnSelectMode = s, this.viewportStartRow = n, this.viewportEndRow = o, this.viewportCappedStartRow = a, this.viewportCappedEndRow = l, this.startCol = t[0], this.endCol = i[0];
  }
...
var ri = "xterm-dom-renderer-owner-", me = "xterm-rows", Lt = "xterm-fg-", Bs = "xterm-bg-", lt = "xterm-focus", Pt = "xterm-selection", Oo = 1, Oi = class extends P {
  constructor(e, t, i, s, r, n, o, a, l, h, c, d, _, f) {
    super(), this._terminal = e, this._document = t, this._element = i, this._screenElement = s, this._viewportElement = r, this._helperContainer = n, this._linkifier2 = o, this._charSizeService = l, this._optionsService = h, this._bufferService = c, this._coreService = d, this._coreBrowserService = _, this._themeService = f, this._terminalClass = Oo++, this._rowElements = [], this._selectionRenderModel = Ao(), this.onRequestRedraw = this._register(new m()).event, this._rowContainer = this._document.createElement("div"), this._rowContainer.classList.add(me), this._rowContainer.style.lineHeight = "normal", this._rowContainer.setAttribute("aria-hidden", "true"), this._refreshRowElements(this._bufferService.cols, this._bufferService.rows), this._selectionContainer = this._document.createElement("div"), this._selectionContainer.classList.add(Pt), this._selectionContainer.setAttribute("aria-hidden", "true"), this.dimensions = Lo(), this._updateDimensions(), this._register(this._optionsService.onOptionChange(() => this._handleOptionsChanged())), this._register(this._themeService.onChangeColors((u) => this._injectCss(u))), this._injectCss(this._themeService.colors), this._rowFactory = a.createInstance(Ai, document), this._element.classList.add(ri + this._terminalClass), this._screenElement.appendChild(this._rowContainer), this._screenElement.appendChild(this._selectionContainer), this._register(this._linkifier2.onShowLinkUnderline((u) => this._handleLinkHover(u))), this._register(this._linkifier2.onHideLinkUnderline((u) => this._handleLinkLeave(u))), this._register($(() => {
      this._element.classList.remove(ri + this._terminalClass), this._rowContainer.remove(), this._selectionContainer.remove(), this._widthCache.dispose(), this._themeStyleElement.remove(), this._dimensionsStyleElement.remove();
    })), this._widthCache = new Po(this._document, this._helperContainer), this._widthCache.setFont(this._optionsService.rawOptions.fontFamily, this._optionsService.rawOptions.fontSize, this._optionsService.rawOptions.fontWeight, this._optionsService.rawOptions.fontWeightBold), this._setDefaultSpacing();
  }
  _updateDimensions() {
    ...
    let t = `${this._terminalSelector} .${me} span { display: inline-block; height: 100%; vertical-align: top;}`;
  ...
  _injectCss(e) {
    ...
    let t = `${this._terminalSelector} .${me} { pointer-events: none; color: ${e.foreground.css}; font-family: ${this._optionsService.rawOptions.fontFamily}; font-size: ${this._optionsService.rawOptions.fontSize}px; font-kerning: none; white-space: pre}`;
    t += `${this._terminalSelector} .${me} .xterm-dim { color: ${F.multiplyOpacity(e.foreground, 0.5).css};}`, t += `${this._terminalSelector} span:not(.xterm-bold) { font-weight: ${this._optionsService.rawOptions.fontWeight};}${this._terminalSelector} span.xterm-bold { font-weight: ${this._optionsService.rawOptions.fontWeightBold};}${this._terminalSelector} span.xterm-italic { font-style: italic;}`;
    let i = `blink_underline_${this._terminalClass}`, s = `blink_bar_${this._terminalClass}`, r = `blink_block_${this._terminalClass}`;
    t += `@keyframes ${i} { 50% {  border-bottom-style: hidden; }}`, t += `@keyframes ${s} { 50% {  box-shadow: none; }}`, t += `@keyframes ${r} { 0% {  background-color: ${e.cursor.css};  color: ${e.cursorAccent.css}; } 50% {  background-color: inherit;  color: ${e.cursor.css}; }}`, t += `${this._terminalSelector} .${me}.${lt} .xterm-cursor.xterm-cursor-blink.xterm-cursor-underline { animation: ${i} 1s step-end infinite;}${this._terminalSelector} .${me}.${lt} .xterm-cursor.xterm-cursor-blink.xterm-cursor-bar { animation: ${s} 1s step-end infinite;}${this._terminalSelector} .${me}.${lt} .xterm-cursor.xterm-cursor-blink.xterm-cursor-block { animation: ${r} 1s step-end infinite;}${this._terminalSelector} .${me} .xterm-cursor.xterm-cursor-block { background-color: ${e.cursor.css}; color: ${e.cursorAccent.css};}${this._terminalSelector} .${me} .xterm-cursor.xterm-cursor-block:not(.xterm-cursor-blink) { background-color: ${e.cursor.css} !important; color: ${e.cursorAccent.css} !important;}${this._terminalSelector} .${me} .xterm-cursor.xterm-cursor-outline { outline: 1px solid ${e.cursor.css}; outline-offset: -1px;}${this._terminalSelector} .${me} .xterm-cursor.xterm-cursor-bar { box-shadow: ${this._optionsService.rawOptions.cursorWidth}px 0 0 ${e.cursor.css} inset;}${this._terminalSelector} .${me} .xterm-cursor.xterm-cursor-underline { border-bottom: 1px ${e.cursor.css}; border-bottom-style: solid; height: calc(100% - 1px);}`, t += `${this._terminalSelector} .${Pt} { position: absolute; top: 0; left: 0; z-index: 1; pointer-events: none;}${this._terminalSelector}.focus .${Pt} div { position: absolute; background-color: ${e.selectionBackgroundOpaque.css};}${this._terminalSelector} .${Pt} div { position: absolute; background-color: ${e.selectionInactiveBackgroundOpaque.css};}`;
    for (let [n, o] of e.ansi.entries()) t += `${this._terminalSelector} .${Lt}${n} { color: ${o.css}; }${this._terminalSelector} .${Lt}${n}.xterm-dim { color: ${F.multiplyOpacity(o, 0.5).css}; }${this._terminalSelector} .${Bs}${n} { background-color: ${o.css}; }`;
    t += `${this._terminalSelector} .${Lt}257 { color: ${F.opaque(e.background).css}; }${this._terminalSelector} .${Lt}257.xterm-dim { color: ${F.multiplyOpacity(F.opaque(e.background), 0.5).css}; }${this._terminalSelector} .${Bs}257 { background-color: ${e.foreground.css}; }`, this._themeStyleElement.textContent = t;
  }
  _setDefaultSpacing() {
  ...
  handleBlur() {
    this._rowContainer.classList.remove(lt), this.renderRows(0, this._bufferService.rows - 1);
  }
  handleFocus() {
    this._rowContainer.classList.add(lt), this.renderRows(this._bufferService.buffer.y, this._bufferService.buffer.y);
  }
  handleSelectionChanged(e, t, i) {
    ...
    if (i) {
      let l = e[0] > t[0];
      a.appendChild(this._createSelectionElement(n, l ? t[0] : e[0], l ? e[0] : t[0], o - n + 1));
    } else {
      let l = s === n ? e[0] : 0, h = n === r ? t[0] : this._bufferService.cols;
      a.appendChild(this._createSelectionElement(n, l, h));
      let c = o - n - 1;
      if (a.appendChild(this._createSelectionElement(n + 1, 0, this._bufferService.cols, c)), n !== o) {
        let d = r === o ? t[0] : this._bufferService.cols;
        a.appendChild(this._createSelectionElement(o, 0, d));
      }
    }
  ...
  renderRows(e, t) {
    ...
    for (let l = e; l <= t; l++) {
      let h = l + i.ydisp, c = this._rowElements[l], d = i.lines.get(h);
      if (!c || !d) break;
      c.replaceChildren(...this._rowFactory.createRow(d, h, h === s, o, a, r, n, this.dimensions.css.cell.width, this._widthCache, -1, -1));
    }
  }
  get _terminalSelector() {
    return `.${ri}${this._terminalClass}`;
  }
  _handleLinkHover(e) {
  ...
  _setCellUnderline(e, t, i, s, r, n) {
    ...
    let a = this._bufferService.buffer, l = a.ybase + a.y, h = Math.min(a.x, r - 1), c = this._optionsService.rawOptions.cursorBlink, d = this._optionsService.rawOptions.cursorStyle, _ = this._optionsService.rawOptions.cursorInactiveStyle;
    for (let f = i; f <= s; ++f) {
      let u = f + a.ydisp, p = this._rowElements[f], S = a.lines.get(u);
      if (!p || !S) break;
      p.replaceChildren(...this._rowFactory.createRow(S, u, u === l, d, _, h, c, this.dimensions.css.cell.width, this._widthCache, n ? f === i ? e : 0 : -1, n ? (f === s ? t : r) - 1 : -1));
    }
  }
};
Oi = Y([w(7, ji), w(8, Xt), w(9, de), w(10, ce), w(11, et), w(12, Oe), w(13, nt)], Oi);
var Ii = class extends P {
  constructor(e, t, i) {
    ...
    try {
      this._measureStrategy = this._register(new No(this._optionsService));
    } catch {
      this._measureStrategy = this._register(new Io(e, t, this._optionsService));
    }
...
var Mr = class extends P {
  ...
  constructor(e, t, i) {
    super(), this._textarea = e, this._window = t, this.mainDocument = i, this._isFocused = !1, this._cachedIsFocused = void 0, this._screenDprMonitor = this._register(new Wo(this._window)), this._onDprChange = this._register(new m()), this.onDprChange = this._onDprChange.event, this._onWindowChange = this._register(new m()), this.onWindowChange = this._onWindowChange.event, this._register(this.onWindowChange((s) => this._screenDprMonitor.setWindow(s))), this._register(oe.forward(this._screenDprMonitor.onDprChange, this._onDprChange)), this._register(R(this._textarea, "focus", () => this._isFocused = !0)), this._register(R(this._textarea, "blur", () => this._isFocused = !1));
  }
  get window() {
    return this._window;
  }
...
var Ni = class {
  ...
  getCoords(e, t, i, s, r) {
    return Fo(window, e, t, i, s, this._charSizeService.hasValidSize, this._renderService.dimensions.css.cell.width, this._renderService.dimensions.css.cell.height, r);
  }
...
Gr(Lr, { getSafariVersion: () => Uo, isChromeOS: () => Or, isFirefox: () => Pr, isIpad: () => qo, isIphone: () => Vo, isLegacyEdge: () => Ko, isLinux: () => rs, isMac: () => Ut, isNode: () => jt, isSafari: () => Tr, isWindows: () => Ar });
var jt = typeof process < "u" && "title" in process, kt = jt ? "node" : navigator.userAgent, Et = jt ? "node" : navigator.platform, Pr = kt.includes("Firefox"), Ko = kt.includes("Edge"), Tr = /^((?!chrome|android).)*safari/i.test(kt);
function Uo() {
  if (!Tr) return 0;
  let e = kt.match(/Version\/(\d+)/);
  return e === null || e.length < 2 ? 0 : parseInt(e[1]);
}
var Ut = ["Macintosh", "MacIntel", "MacPPC", "Mac68K"].includes(Et), qo = Et === "iPad", Vo = Et === "iPhone", Ar = ["Windows", "Win16", "Win32", "WinCE"].includes(Et), rs = Et.indexOf("Linux") >= 0, Or = /\bCrOS\b/.test(kt), Ir = class {
  constructor() {
...
}, qt = !jt && "requestIdleCallback" in window ? Xo : Yo, jo = class {
  constructor() {
    this._queue = new qt();
  }
  set(e) {
...
Hi = Y([w(2, de), w(3, Xt), w(4, et), w(5, xt), w(6, ce), w(7, Oe), w(8, nt)], Hi);
var Go = class {
  constructor(e, t, i) {
...
function Jo(e, t, i, s) {
  ...
  if (!i.buffer.hasScrollback) return ea(r, n, e, t, i, s) + Gt(n, t, i, s) + ta(r, n, e, t, i, s);
  let o;
  if (n === t) return o = r > e ? "D" : "C", bt(Math.abs(r - e), wt(o, s));
  o = n > t ? "D" : "C";
  let a = Math.abs(n - t), l = Qo(n > t ? e : r, i) + (a - 1) * i.cols + 1 + Zo(n > t ? r : e);
  return bt(l, wt(o, s));
}
function Zo(e, t) {
  return e - 1;
...
function ea(e, t, i, s, r, n) {
  return Gt(t, s, r, n).length === 0 ? "" : bt(Hr(e, t, e, t - Qe(t, r), !1, r).length, wt("D", n));
}
function Gt(e, t, i, s) {
  let r = e - Qe(e, i), n = t - Qe(t, i), o = Math.abs(r - n) - ia(e, t, i);
  return bt(o, wt(Nr(e, t), s));
}
function ta(e, t, i, s, r, n) {
  let o;
  Gt(t, s, r, n).length > 0 ? o = s - Qe(s, r) : o = t;
  let a = s, l = sa(e, t, i, s, r, n);
  return bt(Hr(e, o, i, a, l === "C", r).length, wt(l, n));
}
function ia(e, t, i) {
  let s = 0, r = e - Qe(e, i), n = t - Qe(t, i);
...
function sa(e, t, i, s, r, n) {
  let o;
  return Gt(i, s, r, n).length > 0 ? o = s - Qe(s, r) : o = t, e < i && o <= s || e >= i && o < s ? "C" : "D";
}
function Nr(e, t) {
  return e > t ? "A" : "B";
}
function Hr(e, t, i, s, r, n) {
  let o = e, a = t, l = "";
...
var ni = 50, na = 15, oa = 50, aa = 500, ha = " ", la = new RegExp(ha, "g"), Wi = class extends P {
  constructor(e, t, i, s, r, n, o, a, l) {
    ...
    }), this._trimListener = this._bufferService.buffer.lines.onTrim((h) => this._handleTrim(h)), this._register(this._bufferService.buffers.onBufferActivate((h) => this._handleBufferActivate(h))), this.enable(), this._model = new ra(this._bufferService), this._activeSelectionMode = 0, this._register($(() => {
  ...
  get selectionText() {
    ...
    return s.map((r) => r.replace(la, " ")).join(Ar ? `\r
` : `
`);
  }
  clearSelection() {
  ...
  refresh(e) {
    this._refreshAnimationFrame || (this._refreshAnimationFrame = this._coreBrowserService.window.requestAnimationFrame(() => this._refresh())), rs && e && this.selectionText.length && this._onLinuxMouseSelection.fire(this.selectionText);
  }
  _refresh() {
  ...
  _selectWordAtCursor(e, t) {
    ...
    if (i) return this._model.selectionStart = [i.start.x - 1, i.start.y - 1], this._model.selectionStartLength = Ds(i, this._bufferService.cols), this._model.selectionEnd = void 0, !0;
  ...
  _getMouseEventScrollAmount(e) {
    let t = ss(this._coreBrowserService.window, e, this._screenElement)[1], i = this._renderService.dimensions.css.canvas.height;
    return t >= 0 && t <= i ? 0 : (t > i && (t -= i), t = Math.min(Math.max(t, -ni), ni), t /= ni, t / Math.abs(t) + Math.round(t * (na - 1)));
  }
  shouldForceSelection(e) {
    return Ut ? e.altKey && this._optionsService.rawOptions.macOptionClickForcesSelection : e.shiftKey;
  }
  handleMouseDown(e) {
  ...
  _addMouseDownListeners() {
    this._screenElement.ownerDocument && (this._screenElement.ownerDocument.addEventListener("mousemove", this._mouseMoveListener), this._screenElement.ownerDocument.addEventListener("mouseup", this._mouseUpListener)), this._dragScrollIntervalTimer = this._coreBrowserService.window.setInterval(() => this._dragScroll(), oa);
  }
  ...
  shouldColumnSelect(e) {
    return e.altKey && !(Ut && this._optionsService.rawOptions.macOptionClickForcesSelection);
  }
  _handleMouseMove(e) {
  ...
  _handleMouseUp(e) {
    ...
    if (this._removeMouseDownListeners(), this.selectionText.length <= 1 && t < aa && e.altKey && this._optionsService.rawOptions.altClickMovesCursor) {
      if (this._bufferService.buffer.ybase === this._bufferService.buffer.ydisp) {
        ...
        if (i && i[0] !== void 0 && i[1] !== void 0) {
          let s = Jo(i[0] - 1, i[1] - 1, this._bufferService, this._coreService.decPrivateModes.applicationCursorKeys);
  ...
  _getWordAt(e, t, i = !0, s = !0) {
    ...
    if (!n) return;
    let o = r.translateBufferLineToString(e[1], !1), a = this._convertViewportColToCharacterIndex(n, e[0]), l = a, h = e[0] - a, c = 0, d = 0, _ = 0, f = 0;
    if (o.charAt(a) === " ") {
      for (; a > 0 && o.charAt(a - 1) === " "; ) a--;
      for (; l < o.length && o.charAt(l + 1) === " "; ) l++;
    } else {
      let S = e[0], x = e[0];
      n.getWidth(S) === 0 && (c++, S--), n.getWidth(x) === 2 && (d++, x++);
      let H = n.getString(x).length;
      for (H > 1 && (f += H - 1, l += H - 1); S > 0 && a > 0 && !this._isCharWordSeparator(n.loadCell(S - 1, this._workCell)); ) {
        n.loadCell(S - 1, this._workCell);
        let T = this._workCell.getChars().length;
        this._workCell.getWidth() === 0 ? (c++, S--) : T > 1 && (_ += T - 1, a -= T - 1), a--, S--;
      }
      for (; x < n.length && l + 1 < o.length && !this._isCharWordSeparator(n.loadCell(x + 1, this._workCell)); ) {
        n.loadCell(x + 1, this._workCell);
        let T = this._workCell.getChars().length;
        this._workCell.getWidth() === 2 ? (d++, x++) : T > 1 && (f += T - 1, l += T - 1), l++, x++;
      }
    }
    l++;
    let u = a + h - c + _, p = Math.min(this._bufferService.cols, l - a + c + d - _ - f);
    if (!(!t && o.slice(a, l).trim() === "")) {
      if (i && u === 0 && n.getCodePoint(0) !== 32) {
        let S = r.lines.get(e[1] - 1);
        if (S && n.isWrapped && S.getCodePoint(this._bufferService.cols - 1) !== 32) {
          let x = this._getWordAt([this._bufferService.cols - 1, e[1] - 1], !1, !0, !1);
          if (x) {
            let H = this._bufferService.cols - x.start;
            u -= H, p += H;
          }
        }
      }
      if (s && u + p === this._bufferService.cols && n.getCodePoint(this._bufferService.cols - 1) !== 32) {
        let S = r.lines.get(e[1] + 1);
        if (S?.isWrapped && S.getCodePoint(0) !== 32) {
          let x = this._getWordAt([0, e[1] + 1], !1, !1, !0);
          x && (p += x.length);
        }
      }
      return { start: u, length: p };
    }
  }
  _selectWordAt(e, t) {
  ...
  _selectLineAt(e) {
    ...
    this._model.selectionStart = [0, t.first], this._model.selectionEnd = void 0, this._model.selectionStartLength = Ds(i, this._bufferService.cols);
  }
};
Wi = Y([w(3, ce), w(4, et), w(5, Gi), w(6, de), w(7, Ie), w(8, Oe)], Wi);
var Rs = class {
  constructor() {
    this._data = {};
  }
  ...
  constructor() {
    this._color = new Rs(), this._css = new Rs();
  }
  setCss(e, t, i) {
    this._css.set(e, t, i);
  }
  ...
  return e;
})()), Xe = q.toColor("#ffffff"), pt = q.toColor("#000000"), Ls = q.toColor("#ffffff"), Ps = pt, ct = { css: "rgba(255, 255, 255, 0.3)", rgba: 4294967117 }, ca = Xe, zi = class extends P {
  constructor(e) {
    super(), this._optionsService = e, this._contrastCache = new Ms(), this._halfContrastCache = new Ms(), this._onChangeColors = this._register(new m()), this.onChangeColors = this._onChangeColors.event, this._colors = { foreground: Xe, background: pt, cursor: Ls, cursorAccent: Ps, selectionForeground: void 0, selectionBackgroundTransparent: ct, selectionBackgroundOpaque: F.blend(pt, ct), selectionInactiveBackgroundTransparent: ct, selectionInactiveBackgroundOpaque: F.blend(pt, ct), scrollbarSliderBackground: F.opacity(Xe, 0.2), scrollbarSliderHoverBackground: F.opacity(Xe, 0.4), scrollbarSliderActiveBackground: F.opacity(Xe, 0.5), overviewRulerBorder: Xe, ansi: J.slice(), contrastCache: this._contrastCache, halfContrastCache: this._halfContrastCache }, this._updateRestoreColors(), this._setTheme(this._optionsService.rawOptions.theme), this._register(this._optionsService.onSpecificOptionChange("minimumContrastRatio", () => this._contrastCache.clear())), this._register(this._optionsService.onSpecificOptionChange("theme", () => this._setTheme(this._optionsService.rawOptions.theme)));
  }
  get colors() {
    return this._colors;
  }
  _setTheme(e = {}) {
    let t = this._colors;
    if (t.foreground = N(e.foreground, Xe), t.background = N(e.background, pt), t.cursor = F.blend(t.background, N(e.cursor, Ls)), t.cursorAccent = F.blend(t.background, N(e.cursorAccent, Ps)), t.selectionBackgroundTransparent = N(e.selectionBackground, ct), t.selectionBackgroundOpaque = F.blend(t.background, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundTransparent = N(e.selectionInactiveBackground, t.selectionBackgroundTransparent), t.selectionInactiveBackgroundOpaque = F.blend(t.background, t.selectionInactiveBackgroundTransparent), t.selectionForeground = e.selectionForeground ? N(e.selectionForeground, ks) : void 0, t.selectionForeground === ks && (t.selectionForeground = void 0), F.isOpaque(t.selectionBackgroundTransparent) && (t.selectionBackgroundTransparent = F.opacity(t.selectionBackgroundTransparent, 0.3)), F.isOpaque(t.selectionInactiveBackgroundTransparent) && (t.selectionInactiveBackgroundTransparent = F.opacity(t.selectionInactiveBackgroundTransparent, 0.3)), t.scrollbarSliderBackground = N(e.scrollbarSliderBackground, F.opacity(t.foreground, 0.2)), t.scrollbarSliderHoverBackground = N(e.scrollbarSliderHoverBackground, F.opacity(t.foreground, 0.4)), t.scrollbarSliderActiveBackground = N(e.scrollbarSliderActiveBackground, F.opacity(t.foreground, 0.5)), t.overviewRulerBorder = N(e.overviewRulerBorder, ca), t.ansi = J.slice(), t.ansi[0] = N(e.black, J[0]), t.ansi[1] = N(e.red, J[1]), t.ansi[2] = N(e.green, J[2]), t.ansi[3] = N(e.yellow, J[3]), t.ansi[4] = N(e.blue, J[4]), t.ansi[5] = N(e.magenta, J[5]), t.ansi[6] = N(e.cyan, J[6]), t.ansi[7] = N(e.white, J[7]), t.ansi[8] = N(e.brightBlack, J[8]), t.ansi[9] = N(e.brightRed, J[9]), t.ansi[10] = N(e.brightGreen, J[10]), t.ansi[11] = N(e.brightYellow, J[11]), t.ansi[12] = N(e.brightBlue, J[12]), t.ansi[13] = N(e.brightMagenta, J[13]), t.ansi[14] = N(e.brightCyan, J[14]), t.ansi[15] = N(e.brightWhite, J[15]), e.extendedAnsi) {
      let i = Math.min(t.ansi.length - 16, e.extendedAnsi.length);
      for (let s = 0; s < i; s++) t.ansi[s + 16] = N(e.extendedAnsi[s], J[s + 16]);
    }
...
var da = class {
  ...
  constructor() {
    this._services = new da(), this._services.set(ji, this);
  }
  setService(e, t) {
  ...
  createInstance(e, ...t) {
    let i = rn(e).sort((n, o) => n.index - o.index), s = [];
    for (let n of i) {
...
}, _a = { trace: 0, debug: 1, info: 2, warn: 3, error: 4, off: 5 }, fa = "xterm.js: ", Fi = class extends P {
  constructor(e) {
  ...
  _updateLogLevel() {
    this._logLevel = _a[this._optionsService.rawOptions.logLevel];
  }
  _evalLazyOptionalParams(e) {
    for (let t = 0; t < e.length; t++) typeof e[t] == "function" && (e[t] = e[t]());
  }
  _log(e, t, i) {
    this._evalLazyOptionalParams(i), e.call(console, (this._optionsService.options.logger ? "" : fa) + t, ...i);
  }
  trace(e, ...t) {
...
var Ts = class extends P {
...
}, L = 3, j = Object.freeze(new Ct()), Tt = 0, oi = 2, gt = class Wr {
  constructor(t, i, s = !1) {
    this.isWrapped = s, this._combined = {}, this._extendedAttrs = {}, this._data = new Uint32Array(t * L);
    let r = i || be.fromCharData([0, rr, 1, 0]);
    for (let n = 0; n < t; ++n) this.setCell(n, r);
    this.length = t;
  }
  get(t) {
    let i = this._data[t * L + 0], s = i & 2097151;
    return [this._data[t * L + 1], i & 2097152 ? this._combined[t] : s ? Ke(s) : "", i >> 22, i & 2097152 ? this._combined[t].charCodeAt(this._combined[t].length - 1) : s];
  }
  set(t, i) {
    this._data[t * L + 1] = i[0], i[1].length > 1 ? (this._combined[t] = i[1], this._data[t * L + 0] = t | 2097152 | i[2] << 22) : this._data[t * L + 0] = i[1].charCodeAt(0) | i[2] << 22;
  }
  getWidth(t) {
    return this._data[t * L + 0] >> 22;
  }
  hasWidth(t) {
    return this._data[t * L + 0] & 12582912;
  }
  getFg(t) {
    return this._data[t * L + 1];
  }
  getBg(t) {
    return this._data[t * L + 2];
  }
  hasContent(t) {
    return this._data[t * L + 0] & 4194303;
  }
  getCodePoint(t) {
    let i = this._data[t * L + 0];
    return i & 2097152 ? this._combined[t].charCodeAt(this._combined[t].length - 1) : i & 2097151;
  }
  isCombined(t) {
    return this._data[t * L + 0] & 2097152;
  }
  getString(t) {
    let i = this._data[t * L + 0];
  ...
  isProtected(t) {
    return this._data[t * L + 2] & 536870912;
  }
  loadCell(t, i) {
    return Tt = t * L, i.content = this._data[Tt + 0], i.fg = this._data[Tt + 1], i.bg = this._data[Tt + 2], i.content & 2097152 && (i.combinedData = this._combined[t]), i.bg & 268435456 && (i.extended = this._extendedAttrs[t]), i;
  }
  setCell(t, i) {
    i.content & 2097152 && (this._combined[t] = i.combinedData), i.bg & 268435456 && (this._extendedAttrs[t] = i.extended), this._data[t * L + 0] = i.content, this._data[t * L + 1] = i.fg, this._data[t * L + 2] = i.bg;
  }
  setCellFromCodepoint(t, i, s, r) {
    r.bg & 268435456 && (this._extendedAttrs[t] = r.extended), this._data[t * L + 0] = i | s << 22, this._data[t * L + 1] = r.fg, this._data[t * L + 2] = r.bg;
  }
  addCodepointToCell(t, i, s) {
    let r = this._data[t * L + 0];
    r & 2097152 ? this._combined[t] += Ke(i) : r & 2097151 ? (this._combined[t] = Ke(r & 2097151) + Ke(i), r &= -2097152, r |= 2097152) : r = i | 1 << 22, s && (r &= -12582913, r |= s << 22), this._data[t * L + 0] = r;
  }
  insertCells(t, i, s) {
  ...
  resize(t, i) {
    if (t === this.length) return this._data.length * 4 * oi < this._data.buffer.byteLength;
    let s = t * L;
    if (t > this.length) {
    ...
    return this.length = t, s * 4 * oi < this._data.buffer.byteLength;
  }
  cleanupMemory() {
    if (this._data.length * 4 * oi < this._data.buffer.byteLength) {
  ...
  getTrimmedLength() {
    for (let t = this.length - 1; t >= 0; --t) if (this._data[t * L + 0] & 4194303) return t + (this._data[t * L + 0] >> 22);
    return 0;
  }
  getNoBgTrimmedLength() {
    for (let t = this.length - 1; t >= 0; --t) if (this._data[t * L + 0] & 4194303 || this._data[t * L + 2] & 50331648) return t + (this._data[t * L + 0] >> 22);
    return 0;
  }
  copyCellsFrom(t, i, s, r, n) {
    let o = t._data;
    if (n) for (let l = r - 1; l >= 0; l--) {
      for (let h = 0; h < L; h++) this._data[(s + l) * L + h] = o[(i + l) * L + h];
      o[(i + l) * L + 2] & 268435456 && (this._extendedAttrs[s + l] = t._extendedAttrs[i + l]);
    }
    ...
    for (let l = 0; l < a.length; l++) {
      ...
      h >= i && (this._combined[h - i + s] = t._combined[h]);
    }
  }
  translateToString(t, i, s, r) {
    ...
    let n = "";
    for (; i < s; ) {
      let o = this._data[i * L + 0], a = o & 2097151, l = o & 2097152 ? this._combined[i] : a ? Ke(a) : Ue;
...
function pa(e, t, i, s, r, n) {
  let o = [];
  for (let a = 0; a < e.length - 1; a++) {
    let l = a, h = e.get(++l);
    if (!h.isWrapped) continue;
    let c = [e.get(a)];
    for (; l < e.length && h.isWrapped; ) c.push(h), h = e.get(++l);
    if (!n && s >= a && s < l) {
      a += c.length - 1;
      continue;
    }
    let d = 0, _ = yt(c, d, t), f = 1, u = 0;
    for (; f < c.length; ) {
      let S = yt(c, f, t), x = S - u, H = i - _, T = Math.min(x, H);
      c[d].copyCellsFrom(c[f], u, _, T, !1), _ += T, _ === i && (d++, _ = 0), u += T, u === S && (f++, u = 0), _ === 0 && d !== 0 && c[d - 1].getWidth(i - 1) === 2 && (c[d].copyCellsFrom(c[d - 1], i - 1, _++, 1, !1), c[d - 1].setCell(i - 1, r));
    }
    c[d].replaceCells(_, i, r);
    let p = 0;
    for (let S = c.length - 1; S > 0 && (S > d || c[S].getTrimmedLength() === 0); S--) p++;
    p > 0 && (o.push(a + c.length - p), o.push(p)), a += c.length - 1;
  }
  return o;
}
function ga(e, t) {
...
function ma(e, t, i) {
  let s = [], r = e.map((l, h) => yt(e, h, t)).reduce((l, h) => l + h), n = 0, o = 0, a = 0;
  for (; a < r; ) {
    if (r - a < i) {
      s.push(r - a);
      break;
...
var zr = class Fr {
  constructor(t) {
    this.line = t, this.isDisposed = !1, this._disposables = [], this._id = Fr._nextId++, this._onDispose = this.register(new m()), this.onDispose = this._onDispose.event;
  }
  get id() {
    return this._id;
  }
  dispose() {
    this.isDisposed || (this.isDisposed = !0, this.line = -1, this._onDispose.fire(), Ze(this._disposables), this._disposables.length = 0);
  }
  register(t) {
...
var As = 4294967295, Os = class {
  constructor(e, t, i) {
    this._hasScrollback = e, this._optionsService = t, this._bufferService = i, this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.tabs = {}, this.savedY = 0, this.savedX = 0, this.savedCurAttrData = j.clone(), this.savedCharset = je, this.markers = [], this._nullCell = be.fromCharData([0, rr, 1, 0]), this._whitespaceCell = be.fromCharData([0, Ue, 1, 32]), this._isClearing = !1, this._memoryCleanupQueue = new qt(), this._memoryCleanupPosition = 0, this._cols = this._bufferService.cols, this._rows = this._bufferService.rows, this.lines = new Ts(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
  }
  getNullCell(e) {
    return e ? (this._nullCell.fg = e.fg, this._nullCell.bg = e.bg, this._nullCell.extended = e.extended) : (this._nullCell.fg = 0, this._nullCell.bg = 0, this._nullCell.extended = new Ft()), this._nullCell;
  }
  getWhitespaceCell(e) {
    return e ? (this._whitespaceCell.fg = e.fg, this._whitespaceCell.bg = e.bg, this._whitespaceCell.extended = e.extended) : (this._whitespaceCell.fg = 0, this._whitespaceCell.bg = 0, this._whitespaceCell.extended = new Ft()), this._whitespaceCell;
  }
  getBlankLine(e, t) {
    return new gt(this._bufferService.cols, this.getNullCell(e), t);
  }
  get hasScrollback() {
  ...
  clear() {
    this.ydisp = 0, this.ybase = 0, this.y = 0, this.x = 0, this.lines = new Ts(this._getCorrectBufferLength(this._rows)), this.scrollTop = 0, this.scrollBottom = this._rows - 1, this.setupTabStops();
  }
  resize(e, t) {
    ...
    if (r > this.lines.maxLength && (this.lines.maxLength = r), this.lines.length > 0) {
      ...
      let n = 0;
      if (this._rows < t) for (let o = this._rows; o < t; o++) this.lines.length < t + this.ybase && (this._optionsService.rawOptions.windowsMode || this._optionsService.rawOptions.windowsPty.backend !== void 0 || this._optionsService.rawOptions.windowsPty.buildNumber !== void 0 ? this.lines.push(new gt(e, i)) : this.ybase > 0 && this.lines.length <= this.ybase + this.y + n + 1 ? (this.ybase--, n++, this.ydisp > 0 && this.ydisp--) : this.lines.push(new gt(e, i)));
  ...
  _reflowLarger(e, t) {
    let i = this._optionsService.rawOptions.reflowCursorLine, s = pa(this.lines, this._cols, e, this.ybase + this.y, this.getNullCell(j), i);
    if (s.length > 0) {
      let r = ga(this.lines, s);
      va(this.lines, r.layout), this._reflowLargerAdjustViewport(e, t, r.countRemoved);
    }
  }
  _reflowLargerAdjustViewport(e, t, i) {
    let s = this.getNullCell(j), r = i;
    for (; r-- > 0; ) this.ybase === 0 ? (this.y > 0 && this.y--, this.lines.length < t && this.lines.push(new gt(e, s))) : (this.ydisp === this.ybase && this.ydisp--, this.ybase--);
  ...
  _reflowSmaller(e, t) {
    ...
    for (let o = this.lines.length - 1; o >= 0; o--) {
      ...
      if (!i) {
        ...
        if (T >= o && T < o + l.length) continue;
      }
      let h = l[l.length - 1].getTrimmedLength(), c = ma(l, this._cols, e), d = c.length - l.length, _;
      ...
      let u = c.length - 1, p = c[u];
      p === 0 && (u--, p = c[u]);
      let S = l.length - d - 1, x = h;
      for (; S >= 0; ) {
        let T = Math.min(x, p);
        if (l[u] === void 0) break;
        if (l[u].copyCellsFrom(l[S], x - T, p - T, T, !0), p -= T, p === 0 && (u--, p = c[u]), x -= T, x === 0) {
          S--;
          let B = Math.max(S, 0);
          x = yt(l, B, this._cols);
        }
      }
      for (let T = 0; T < l.length; T++) c[T] < e && l[T].setCell(c[T], s);
      let H = d - _;
      for (; H-- > 0; ) this.ybase === 0 ? this.y < t - 1 ? (this.y++, this.lines.pop()) : (this.ybase++, this.ydisp++) : this.ybase < Math.min(this.lines.maxLength, this.lines.length + n) - t && (this.ybase === this.ydisp && this.ydisp++, this.ybase++);
      this.savedY = Math.min(this.savedY + d, this.ybase + t - 1);
    }
    if (r.length > 0) {
      let o = [], a = [];
      for (let p = 0; p < this.lines.length; p++) a.push(this.lines.get(p));
      let l = this.lines.length, h = l - 1, c = 0, d = r[c];
      this.lines.length = Math.min(this.lines.maxLength, this.lines.length + n);
      let _ = 0;
      for (let p = Math.min(this.lines.maxLength - 1, l + n - 1); p >= 0; p--) if (d && d.start > h + _) {
        for (let S = d.newLines.length - 1; S >= 0; S--) this.lines.set(p--, d.newLines[S]);
        p++, o.push({ index: h + 1, amount: d.newLines.length }), _ += d.newLines.length, d = r[++c];
      } else this.lines.set(p, a[h--]);
      let f = 0;
  ...
  reset() {
    this._normal = new Os(!0, this._optionsService, this._bufferService), this._normal.fillViewportRows(), this._alt = new Os(!1, this._optionsService, this._bufferService), this._activeBuffer = this._normal, this._onBufferActivate.fire({ activeBuffer: this._normal, inactiveBuffer: this._alt }), this.setupTabStops();
  }
  get alt() {
    return this._alt;
  }
...
}, $r = 2, Kr = 1, $i = class extends P {
  constructor(e) {
    super(), this.isUserScrolling = !1, this._onResize = this._register(new m()), this.onResize = this._onResize.event, this._onScroll = this._register(new m()), this.onScroll = this._onScroll.event, this.cols = Math.max(e.rawOptions.cols || 0, $r), this.rows = Math.max(e.rawOptions.rows || 0, Kr), this.buffers = this._register(new wa(e, this)), this._register(this.buffers.onBufferActivate((t) => {
...
$i = Y([w(0, de)], $i);
var it = { cols: 80, rows: 24, cursorBlink: !1, cursorStyle: "block", cursorWidth: 1, cursorInactiveStyle: "outline", customGlyphs: !0, drawBoldTextInBrightColors: !0, documentOverride: null, fastScrollModifier: "alt", fastScrollSensitivity: 5, fontFamily: "monospace", fontSize: 15, fontWeight: "normal", fontWeightBold: "bold", ignoreBracketedPasteMode: !1, lineHeight: 1, letterSpacing: 0, linkHandler: null, logLevel: "info", logger: null, scrollback: 1e3, scrollOnEraseInDisplay: !1, scrollOnUserInput: !0, scrollSensitivity: 1, screenReaderMode: !1, smoothScrollDuration: 0, macOptionIsMeta: !1, macOptionClickForcesSelection: !1, minimumContrastRatio: 1, disableStdin: !1, allowProposedApi: !1, allowTransparency: !1, tabStopWidth: 8, theme: {}, reflowCursorLine: !1, rescaleOverlappingGlyphs: !1, rightClickSelectsWord: Ut, windowOptions: {}, windowsMode: !1, windowsPty: {}, wordSeparator: " ()[]{}',\"`", altClickMovesCursor: !0, convertEol: !1, termName: "xterm", cancelEvents: !1, overviewRuler: {} }, ba = ["normal", "bold", "100", "200", "300", "400", "500", "600", "700", "800", "900"], ya = class extends P {
  constructor(e) {
  ...
  _sanitizeAndValidateOption(e, t) {
    switch (e) {
      case "cursorStyle":
        if (t || (t = it[e]), !Ca(t)) throw new Error(`"${t}" is not a valid value for ${e}`);
        break;
      case "wordSeparator":
        t || (t = it[e]);
        break;
...
function vt(e, t = 5) {
  ...
  for (let s in e) i[s] = t <= 1 ? e[s] : e[s] && vt(e[s], t - 1);
  return i;
}
var Is = Object.freeze({ insertMode: !1 }), Ns = Object.freeze({ applicationCursorKeys: !1, applicationKeypad: !1, bracketedPasteMode: !1, cursorBlink: void 0, cursorStyle: void 0, origin: !1, reverseWraparound: !1, sendFocus: !1, synchronizedOutput: !1, wraparound: !0 }), Ki = class extends P {
  constructor(e, t, i) {
    super(), this._bufferService = e, this._logService = t, this._optionsService = i, this.isCursorInitialized = !1, this.isCursorHidden = !1, this._onData = this._register(new m()), this.onData = this._onData.event, this._onUserInput = this._register(new m()), this.onUserInput = this._onUserInput.event, this._onBinary = this._register(new m()), this.onBinary = this._onBinary.event, this._onRequestScrollToBottom = this._register(new m()), this.onRequestScrollToBottom = this._onRequestScrollToBottom.event, this.modes = vt(Is), this.decPrivateModes = vt(Ns);
  }
  reset() {
    this.modes = vt(Is), this.decPrivateModes = vt(Ns);
  }
...
Ki = Y([w(0, ce), w(1, lr), w(2, de)], Ki);
var Hs = { NONE: { events: 0, restrict: () => !1 }, X10: { events: 1, restrict: (e) => e.button === 4 || e.action !== 1 ? !1 : (e.ctrl = !1, e.alt = !1, e.shift = !1, !0) }, VT200: { events: 19, restrict: (e) => e.action !== 32 }, DRAG: { events: 23, restrict: (e) => !(e.action === 32 && e.button === 3) }, ANY: { events: 31, restrict: (e) => !0 } };
function ai(e, t) {
...
var hi = String.fromCharCode, Ws = { DEFAULT: (e) => {
  let t = [ai(e, !1) + 32, e.col + 32, e.row + 32];
  return t[0] > 255 || t[1] > 255 || t[2] > 255 ? "" : `\x1B[M${hi(t[0])}${hi(t[1])}${hi(t[2])}`;
}, SGR: (e) => {
  let t = e.action === 0 && e.button !== 4 ? "m" : "M";
  return `\x1B[<${ai(e, !0)};${e.col};${e.row}${t}`;
}, SGR_PIXELS: (e) => {
  let t = e.action === 0 && e.button !== 4 ? "m" : "M";
  return `\x1B[<${ai(e, !0)};${e.x};${e.y}${t}`;
} }, Ui = class extends P {
  constructor(e, t, i) {
    ...
    for (let s of Object.keys(Hs)) this.addProtocol(s, Hs[s]);
    for (let s of Object.keys(Ws)) this.addEncoding(s, Ws[s]);
    this.reset();
  }
  addProtocol(e, t) {
    this._protocols[e] = t;
...
Ui = Y([w(0, ce), w(1, et), w(2, de)], Ui);
var li = [[768, 879], [1155, 1158], [1160, 1161], [1425, 1469], [1471, 1471], [1473, 1474], [1476, 1477], [1479, 1479], [1536, 1539], [1552, 1557], [1611, 1630], [1648, 1648], [1750, 1764], [1767, 1768], [1770, 1773], [1807, 1807], [1809, 1809], [1840, 1866], [1958, 1968], [2027, 2035], [2305, 2306], [2364, 2364], [2369, 2376], [2381, 2381], [2385, 2388], [2402, 2403], [2433, 2433], [2492, 2492], [2497, 2500], [2509, 2509], [2530, 2531], [2561, 2562], [2620, 2620], [2625, 2626], [2631, 2632], [2635, 2637], [2672, 2673], [2689, 2690], [2748, 2748], [2753, 2757], [2759, 2760], [2765, 2765], [2786, 2787], [2817, 2817], [2876, 2876], [2879, 2879], [2881, 2883], [2893, 2893], [2902, 2902], [2946, 2946], [3008, 3008], [3021, 3021], [3134, 3136], [3142, 3144], [3146, 3149], [3157, 3158], [3260, 3260], [3263, 3263], [3270, 3270], [3276, 3277], [3298, 3299], [3393, 3395], [3405, 3405], [3530, 3530], [3538, 3540], [3542, 3542], [3633, 3633], [3636, 3642], [3655, 3662], [3761, 3761], [3764, 3769], [3771, 3772], [3784, 3789], [3864, 3865], [3893, 3893], [3895, 3895], [3897, 3897], [3953, 3966], [3968, 3972], [3974, 3975], [3984, 3991], [3993, 4028], [4038, 4038], [4141, 4144], [4146, 4146], [4150, 4151], [4153, 4153], [4184, 4185], [4448, 4607], [4959, 4959], [5906, 5908], [5938, 5940], [5970, 5971], [6002, 6003], [6068, 6069], [6071, 6077], [6086, 6086], [6089, 6099], [6109, 6109], [6155, 6157], [6313, 6313], [6432, 6434], [6439, 6440], [6450, 6450], [6457, 6459], [6679, 6680], [6912, 6915], [6964, 6964], [6966, 6970], [6972, 6972], [6978, 6978], [7019, 7027], [7616, 7626], [7678, 7679], [8203, 8207], [8234, 8238], [8288, 8291], [8298, 8303], [8400, 8431], [12330, 12335], [12441, 12442], [43014, 43014], [43019, 43019], [43045, 43046], [64286, 64286], [65024, 65039], [65056, 65059], [65279, 65279], [65529, 65531]], xa = [[68097, 68099], [68101, 68102], [68108, 68111], [68152, 68154], [68159, 68159], [119143, 119145], [119155, 119170], [119173, 119179], [119210, 119213], [119362, 119364], [917505, 917505], [917536, 917631], [917760, 917999]], Z;
function ka(e, t) {
...
var Ea = class {
  constructor() {
    if (this.version = "6", !Z) {
      ...
      for (let e = 0; e < li.length; ++e) Z.fill(0, li[e][0], li[e][1] + 1);
    }
  }
  wcwidth(e) {
    return e < 32 ? 0 : e < 127 ? 1 : e < 65536 ? Z[e] : ka(e, xa) ? 0 : e >= 131072 && e <= 196605 || e >= 196608 && e <= 262141 ? 2 : 1;
  }
  charProperties(e, t) {
    let i = this.wcwidth(e), s = i === 0 && t !== 0;
    if (s) {
      let r = Ge.extractWidth(t);
      r === 0 ? s = !1 : r > i && (i = r);
    }
    return Ge.createPropertyValue(0, i, s);
  }
}, Ge = class zt {
  constructor() {
  ...
  getStringCellWidth(t) {
    ...
    for (let n = 0; n < r; ++n) {
      ...
      if (55296 <= o && o <= 56319) {
        ...
        let h = t.charCodeAt(n);
        56320 <= h && h <= 57343 ? o = (o - 55296) * 1024 + h - 56320 + 65536 : i += this.wcwidth(h);
      }
      let a = this.charProperties(o, s), l = zt.extractWidth(a);
      zt.extractShouldJoin(a) && (l -= zt.extractWidth(s)), i += l, s = a;
    }
    return i;
  }
  charProperties(t, i) {
...
var dt = 2147483647, Da = 256, Ur = class qi {
  constructor(t = 32, i = 32) {
    if (this.maxLength = t, this.maxSubParamsLength = i, i > Da) throw new Error("maxSubParamsLength must not be greater than 256");
  ...
  clone() {
    let t = new qi(this.maxLength, this.maxSubParamsLength);
  ...
  addParam(t) {
    ...
    this._subParamsIdx[this.length] = this._subParamsLength << 8 | this._subParamsLength, this.params[this.length++] = t > dt ? dt : t;
  }
  addSubParam(t) {
    if (this._digitIsSub = !0, !!this.length) {
      ...
      if (t < -1) throw new Error("values lesser than -1 are not allowed");
      this._subParams[this._subParamsLength++] = t > dt ? dt : t, this._subParamsIdx[this.length - 1]++;
    }
  }
  hasSubParams(t) {
  ...
  addDigit(t) {
    ...
    s[i - 1] = ~r ? Math.min(r * 10 + t, dt) : t;
  }
}, ut = [], Ra = class {
  constructor() {
    this._state = 0, this._active = ut, this._id = -1, this._handlers = /* @__PURE__ */ Object.create(null), this._handlerFb = () => {
  ...
  reset() {
    ...
    this._stack.paused = !1, this._active = ut, this._id = -1, this._state = 0;
  }
  _start() {
    if (this._active = this._handlers[this._id] || ut, !this._active.length) this._handlerFb(this._id, "START");
    else for (let e = this._active.length - 1; e >= 0; e--) this._active[e].start();
  }
  _put(e, t, i) {
    if (!this._active.length) this._handlerFb(this._id, "PUT", Yt(e, t, i));
  ...
  put(e, t, i) {
    ...
    if (this._state !== 0) {
      ...
      this._active = ut, this._id = -1, this._state = 0;
    }
  }
}, pe = class {
  constructor(e) {
  ...
  put(e, t, i) {
    this._hitLimit || (this._data += Yt(e, t, i), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
  }
  end(e) {
    let t = !1;
  ...
  put(e, t, i) {
    if (!this._active.length) this._handlerFb(this._ident, "PUT", Yt(e, t, i));
    else for (let s = this._active.length - 1; s >= 0; s--) this._active[s].put(e, t, i);
  }
  unhook(e, t = !0) {
...
var Fs = class {
  constructor(e) {
    this._handler = e, this._data = "", this._params = mt, this._hitLimit = !1;
  }
  hook(e) {
    this._params = e.length > 1 || e.params[0] ? e.clone() : mt, this._data = "", this._hitLimit = !1;
  }
  put(e, t, i) {
    this._hitLimit || (this._data += Yt(e, t, i), this._data.length > 1e7 && (this._data = "", this._hitLimit = !0));
  }
  unhook(e) {
    let t = !1;
    if (this._hitLimit) t = !1;
    else if (e && (t = this._handler(this._data, this._params), t instanceof Promise)) return t.then((i) => (this._params = mt, this._data = "", this._hitLimit = !1, i));
    return this._params = mt, this._data = "", this._hitLimit = !1, t;
  }
}, La = class {
  constructor(e) {
  ...
  let e = new La(4095), t = Array.apply(null, Array(256)).map((a, l) => l), i = (a, l) => t.slice(a, l), s = i(32, 127), r = i(0, 24);
  ...
  return e.addMany(r, 0, 3, 0), e.addMany(r, 1, 3, 1), e.add(127, 1, 0, 1), e.addMany(r, 8, 0, 8), e.addMany(r, 3, 3, 3), e.add(127, 3, 0, 3), e.addMany(r, 4, 3, 4), e.add(127, 4, 0, 4), e.addMany(r, 6, 3, 6), e.addMany(r, 5, 3, 5), e.add(127, 5, 0, 5), e.addMany(r, 2, 3, 2), e.add(127, 2, 0, 2), e.add(93, 1, 4, 8), e.addMany(s, 8, 5, 8), e.add(127, 8, 5, 8), e.addMany([156, 27, 24, 26, 7], 8, 6, 0), e.addMany(i(28, 32), 8, 0, 8), e.addMany([88, 94, 95], 1, 0, 7), e.addMany(s, 7, 0, 7), e.addMany(r, 7, 0, 7), e.add(156, 7, 0, 0), e.add(127, 7, 0, 7), e.add(91, 1, 11, 3), e.addMany(i(64, 127), 3, 7, 0), e.addMany(i(48, 60), 3, 8, 4), e.addMany([60, 61, 62, 63], 3, 9, 4), e.addMany(i(48, 60), 4, 8, 4), e.addMany(i(64, 127), 4, 7, 0), e.addMany([60, 61, 62, 63], 4, 0, 6), e.addMany(i(32, 64), 6, 0, 6), e.add(127, 6, 0, 6), e.addMany(i(64, 127), 6, 0, 0), e.addMany(i(32, 48), 3, 9, 5), e.addMany(i(32, 48), 5, 9, 5), e.addMany(i(48, 64), 5, 0, 6), e.addMany(i(64, 127), 5, 7, 0), e.addMany(i(32, 48), 4, 9, 5), e.addMany(i(32, 48), 1, 9, 2), e.addMany(i(32, 48), 2, 9, 2), e.addMany(i(48, 127), 2, 10, 0), e.addMany(i(48, 80), 1, 10, 0), e.addMany(i(81, 88), 1, 10, 0), e.addMany([89, 90, 92], 1, 10, 0), e.addMany(i(96, 127), 1, 10, 0), e.add(80, 1, 11, 9), e.addMany(r, 9, 0, 9), e.add(127, 9, 0, 9), e.addMany(i(28, 32), 9, 0, 9), e.addMany(i(32, 48), 9, 9, 12), e.addMany(i(48, 60), 9, 8, 10), e.addMany([60, 61, 62, 63], 9, 9, 10), e.addMany(r, 11, 0, 11), e.addMany(i(32, 128), 11, 0, 11), e.addMany(i(28, 32), 11, 0, 11), e.addMany(r, 10, 0, 10), e.add(127, 10, 0, 10), e.addMany(i(28, 32), 10, 0, 10), e.addMany(i(48, 60), 10, 8, 10), e.addMany([60, 61, 62, 63], 10, 0, 11), e.addMany(i(32, 48), 10, 9, 12), e.addMany(r, 12, 0, 12), e.add(127, 12, 0, 12), e.addMany(i(28, 32), 12, 0, 12), e.addMany(i(32, 48), 12, 9, 12), e.addMany(i(48, 64), 12, 0, 11), e.addMany(i(64, 127), 12, 12, 13), e.addMany(i(64, 127), 10, 12, 13), e.addMany(i(64, 127), 9, 12, 13), e.addMany(r, 13, 13, 13), e.addMany(s, 13, 13, 13), e.add(127, 13, 0, 13), e.addMany([27, 156, 24, 26], 13, 14, 0), e.add(we, 0, 2, 0), e.add(we, 8, 5, 8), e.add(we, 6, 0, 6), e.add(we, 11, 0, 11), e.add(we, 13, 13, 13), e;
})(), Ta = class extends P {
  constructor(e = Pa) {
    super(), this._transitions = e, this._parseStack = { state: 0, handlers: [], handlerPos: 0, transition: 0, chunkPos: 0 }, this.initialState = 0, this.currentState = this.initialState, this._params = new Ur(), this._params.addParam(0), this._collect = 0, this.precedingJoinState = 0, this._printHandlerFb = (t, i, s) => {
    ...
    })), this._oscParser = this._register(new Ra()), this._dcsParser = this._register(new Ma()), this._errorHandler = this._errorHandlerFb, this.registerEscHandler({ final: "\\" }, () => !0);
  }
  ...
  parse(e, t, i) {
    ...
    if (this._parseStack.state) if (this._parseStack.state === 2) this._parseStack.state = 0, n = this._parseStack.chunkPos + 1;
      ...
      let a = this._parseStack.handlers, l = this._parseStack.handlerPos - 1;
      switch (this._parseStack.state) {
        case 3:
          if (i === !1 && l > -1) {
            for (; l >= 0 && (o = a[l](this._params), o !== !0); l--) if (o instanceof Promise) return this._parseStack.handlerPos = l, o;
          }
          this._parseStack.handlers = [];
          break;
        case 4:
          if (i === !1 && l > -1) {
            for (; l >= 0 && (o = a[l](), o !== !0); l--) if (o instanceof Promise) return this._parseStack.handlerPos = l, o;
          }
          this._parseStack.handlers = [];
          break;
        case 6:
    ...
    for (let a = n; a < t; ++a) {
      switch (s = e[a], r = this._transitions.table[this.currentState << 8 | (s < 160 ? s : we)], r >> 4) {
        case 2:
          for (let _ = a + 1; ; ++_) {
            if (_ >= t || (s = e[_]) < 32 || s > 126 && s < we) {
              this._printHandler(e, a, _), a = _ - 1;
              break;
            }
            if (++_ >= t || (s = e[_]) < 32 || s > 126 && s < we) {
              this._printHandler(e, a, _), a = _ - 1;
        ...
        case 1:
          ...
          break;
        case 7:
          let l = this._csiHandlers[this._collect << 8 | s], h = l ? l.length - 1 : -1;
          for (; h >= 0 && (o = l[h](this._params), o !== !0); h--) if (o instanceof Promise) return this._preserveStack(3, l, h, r, a), o;
        ...
        case 9:
          ...
          break;
        case 10:
          let c = this._escHandlers[this._collect << 8 | s], d = c ? c.length - 1 : -1;
          for (; d >= 0 && (o = c[d](), o !== !0); d--) if (o instanceof Promise) return this._preserveStack(4, c, d, r, a), o;
          d < 0 && this._escHandlerFb(this._collect << 8 | s), this.precedingJoinState = 0;
          break;
        case 11:
        ...
        case 12:
          ...
          break;
        case 13:
          for (let _ = a + 1; ; ++_) if (_ >= t || (s = e[_]) === 24 || s === 26 || s === 27 || s > 127 && s < we) {
            this._dcsParser.put(e, a, _), a = _ - 1;
            break;
          }
          break;
        case 14:
        ...
        case 4:
          ...
          break;
        case 5:
          for (let _ = a + 1; ; _++) if (_ >= t || (s = e[_]) < 32 || s > 127 && s < we) {
            this._oscParser.put(e, a, _), a = _ - 1;
            break;
          }
          break;
        case 6:
...
}, Aa = /^([\da-f])\/([\da-f])\/([\da-f])$|^([\da-f]{2})\/([\da-f]{2})\/([\da-f]{2})$|^([\da-f]{3})\/([\da-f]{3})\/([\da-f]{3})$|^([\da-f]{4})\/([\da-f]{4})\/([\da-f]{4})$/, Oa = /^[\da-f]+$/;
function $s(e) {
  if (!e) return;
  let t = e.toLowerCase();
  if (t.indexOf("rgb:") === 0) {
  ...
  } else if (t.indexOf("#") === 0 && (t = t.slice(1), Oa.exec(t) && [3, 6, 9, 12].includes(t.length))) {
...
function Ia(e, t = 16) {
  let [i, s, r] = e;
  return `rgb:${ci(i, t)}/${ci(s, t)}/${ci(r, t)}`;
}
var Na = { "(": 0, ")": 1, "*": 2, "+": 3, "-": 1, ".": 2 }, $e = 131072, Ks = 10;
function Us(e, t) {
...
var qs = 5e3, Vs = 0, Ha = class extends P {
  ...
  _logSlowResolvingAsync(e) {
    this._logService.logLevel <= 3 && Promise.race([e, new Promise((t, i) => setTimeout(() => i("#SLOW_TIMEOUT"), qs))]).catch((t) => {
      if (t !== "#SLOW_TIMEOUT") throw t;
      console.warn(`async parser handler taking longer than ${qs} ms`);
    });
  }
  _getCurrentLinkId() {
  ...
  print(e, t, i) {
    ...
    this._dirtyRowTracker.markDirty(this._activeBuffer.y), this._activeBuffer.x && i - t > 0 && d.getWidth(this._activeBuffer.x - 1) === 2 && d.setCellFromCodepoint(this._activeBuffer.x - 1, 0, 1, c);
    let _ = this._parser.precedingJoinState;
    for (let f = t; f < i; ++f) {
      if (s = e[f], s < 127 && n) {
        let x = n[String.fromCharCode(s)];
        x && (s = x.charCodeAt(0));
      }
      let u = this._unicodeService.charProperties(s, _);
      r = Ge.extractWidth(u);
      let p = Ge.extractShouldJoin(u), S = p ? Ge.extractWidth(_) : 0;
      if (_ = u, o && this._onA11yChar.fire(Ke(s)), this._getCurrentLinkId() && this._oscLinkService.addLineToLink(this._getCurrentLinkId(), this._activeBuffer.ybase + this._activeBuffer.y), this._activeBuffer.x + r - S > a) {
        if (l) {
          let x = d, H = this._activeBuffer.x - S;
          for (this._activeBuffer.x = S, this._activeBuffer.y++, this._activeBuffer.y === this._activeBuffer.scrollBottom + 1 ? (this._activeBuffer.y--, this._bufferService.scroll(this._eraseAttrData(), !0)) : (this._activeBuffer.y >= this._bufferService.rows && (this._activeBuffer.y = this._bufferService.rows - 1), this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).isWrapped = !0), d = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y), S > 0 && d instanceof gt && d.copyCellsFrom(x, H, 0, S, !1); H < a; ) x.setCellFromCodepoint(H++, 0, 1, c);
        } else if (this._activeBuffer.x = a - 1, r === 2) continue;
      }
      if (p && this._activeBuffer.x) {
        let x = d.getWidth(this._activeBuffer.x - 1) ? 1 : 2;
        d.addCodepointToCell(this._activeBuffer.x - x, s, r);
        for (let H = r - S; --H >= 0; ) d.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, c);
        continue;
      }
      if (h && (d.insertCells(this._activeBuffer.x, r - S, this._activeBuffer.getNullCell(c)), d.getWidth(a - 1) === 2 && d.setCellFromCodepoint(a - 1, 0, 1, c)), d.setCellFromCodepoint(this._activeBuffer.x++, s, r, c), r > 0) for (; --r; ) d.setCellFromCodepoint(this._activeBuffer.x++, 0, 0, c);
    }
    this._parser.precedingJoinState = _, this._activeBuffer.x < a && i - t > 0 && d.getWidth(this._activeBuffer.x) === 0 && !d.hasContent(this._activeBuffer.x) && d.setCellFromCodepoint(this._activeBuffer.x, 0, 1, c), this._dirtyRowTracker.markDirty(this._activeBuffer.y);
  }
  registerCsiHandler(e, t) {
    return e.final === "t" && !e.prefix && !e.intermediates ? this._parser.registerCsiHandler(e, (i) => Us(i.params[0], this._optionsService.rawOptions.windowOptions) ? t(i) : !0) : this._parser.registerCsiHandler(e, t);
  }
  registerDcsHandler(e, t) {
    return this._parser.registerDcsHandler(e, new Fs(t));
  }
  registerEscHandler(e, t) {
  ...
  repeatPrecedingCharacter(e) {
    ...
    if (!t) return !0;
    let i = e.params[0] || 1, s = Ge.extractWidth(t), r = this._activeBuffer.x - s, n = this._activeBuffer.lines.get(this._activeBuffer.ybase + this._activeBuffer.y).getString(r), o = new Uint32Array(n.length * i), a = 0;
  ...
  sendDeviceAttributesPrimary(e) {
    return e.params[0] > 0 || (this._is("xterm") || this._is("rxvt-unicode") || this._is("screen") ? this._coreService.triggerDataEvent(g.ESC + "[?1;2c") : this._is("linux") && this._coreService.triggerDataEvent(g.ESC + "[?6c")), !0;
  }
  sendDeviceAttributesSecondary(e) {
    return e.params[0] > 0 || (this._is("xterm") ? this._coreService.triggerDataEvent(g.ESC + "[>0;276;0c") : this._is("rxvt-unicode") ? this._coreService.triggerDataEvent(g.ESC + "[>85;95;0c") : this._is("linux") ? this._coreService.triggerDataEvent(e.params[0] + "c") : this._is("screen") && this._coreService.triggerDataEvent(g.ESC + "[>83;40003;0c")), !0;
  }
  _is(e) {
  ...
  requestMode(e, t) {
    ...
    let s = this._coreService.decPrivateModes, { activeProtocol: r, activeEncoding: n } = this._coreMouseService, o = this._coreService, { buffers: a, cols: l } = this._bufferService, { active: h, alt: c } = a, d = this._optionsService.rawOptions, _ = (p, S) => (o.triggerDataEvent(`${g.ESC}[${t ? "" : "?"}${p};${S}$y`), !0), f = (p) => p ? 1 : 2, u = e.params[0];
    return t ? u === 2 ? _(u, 4) : u === 4 ? _(u, f(o.modes.insertMode)) : u === 12 ? _(u, 3) : u === 20 ? _(u, f(d.convertEol)) : _(u, 0) : u === 1 ? _(u, f(s.applicationCursorKeys)) : u === 3 ? _(u, d.windowOptions.setWinLines ? l === 80 ? 2 : l === 132 ? 1 : 0 : 0) : u === 6 ? _(u, f(s.origin)) : u === 7 ? _(u, f(s.wraparound)) : u === 8 ? _(u, 3) : u === 9 ? _(u, f(r === "X10")) : u === 12 ? _(u, f(d.cursorBlink)) : u === 25 ? _(u, f(!o.isCursorHidden)) : u === 45 ? _(u, f(s.reverseWraparound)) : u === 66 ? _(u, f(s.applicationKeypad)) : u === 67 ? _(u, 4) : u === 1e3 ? _(u, f(r === "VT200")) : u === 1002 ? _(u, f(r === "DRAG")) : u === 1003 ? _(u, f(r === "ANY")) : u === 1004 ? _(u, f(s.sendFocus)) : u === 1005 ? _(u, 4) : u === 1006 ? _(u, f(n === "SGR")) : u === 1015 ? _(u, 4) : u === 1016 ? _(u, f(n === "SGR_PIXELS")) : u === 1048 ? _(u, 1) : u === 47 || u === 1047 || u === 1049 ? _(u, f(h === c)) : u === 2004 ? _(u, f(s.bracketedPasteMode)) : u === 2026 ? _(u, f(s.synchronizedOutput)) : _(u, 0);
  }
  _updateAttrColor(e, t, i, s, r) {
    return t === 2 ? (e |= 50331648, e &= -16777216, e |= Ct.fromColorRGB([i, s, r])) : t === 5 && (e &= -50331904, e |= 33554432 | i & 255), e;
  }
  _extractColor(e, t, i) {
  ...
  deviceStatus(e) {
    switch (e.params[0]) {
      case 5:
        this._coreService.triggerDataEvent(`${g.ESC}[0n`);
        break;
      case 6:
        let t = this._activeBuffer.y + 1, i = this._activeBuffer.x + 1;
        this._coreService.triggerDataEvent(`${g.ESC}[${t};${i}R`);
        break;
    }
    return !0;
  }
  ...
  windowOptions(e) {
    if (!Us(e.params[0], this._optionsService.rawOptions.windowOptions)) return !0;
    ...
    switch (e.params[0]) {
      ...
      case 16:
        ...
        break;
      case 18:
        this._bufferService && this._coreService.triggerDataEvent(`${g.ESC}[8;${this._bufferService.rows};${this._bufferService.cols}t`);
        break;
      case 22:
        (t === 0 || t === 2) && (this._windowTitleStack.push(this._windowTitle), this._windowTitleStack.length > Ks && this._windowTitleStack.shift()), (t === 0 || t === 1) && (this._iconNameStack.push(this._iconName), this._iconNameStack.length > Ks && this._iconNameStack.shift());
        break;
      case 23:
  ...
  setOrReportIndexedColor(e) {
    ...
    for (; i.length > 1; ) {
      ...
      if (/^\d+$/.exec(s)) {
        let n = parseInt(s);
        if (Ys(n)) if (r === "?") t.push({ type: 0, index: n });
        else {
          let o = $s(r);
  ...
  selectCharset(e) {
    return e.length !== 2 ? (this.selectDefaultCharset(), !0) : (e[0] === "/" || this._charsetService.setgCharset(Na[e[0]], Q[e[1]] || je), !0);
  }
  index() {
  ...
  requestStatusString(e, t) {
    let i = (o) => (this._coreService.triggerDataEvent(`${g.ESC}${o}${g.ESC}\\`), !0), s = this._bufferService.buffer, r = this._optionsService.rawOptions;
  ...
  markRangeDirty(e, t) {
    e > t && (Vs = e, e = t, t = Vs), e < this.start && (this.start = e), t > this.end && (this.end = t);
  }
  markAllDirty() {
...
var Wa = 5e7, Xs = 12, za = 50, Fa = class extends P {
  constructor(e) {
  ...
  write(e, t) {
    if (this._pendingData > Wa) throw new Error("write data discarded, use flow control to avoid losing data");
  ...
  _innerWrite(e = 0, t = !0) {
    ...
    for (; this._writeBuffer.length > this._bufferOffset; ) {
      ...
      if (r) {
        let o = (a) => performance.now() - i >= Xs ? setTimeout(() => this._innerWrite(0, a)) : this._innerWrite(i, a);
      ...
      if (n && n(), this._bufferOffset++, this._pendingData -= s.length, performance.now() - i >= Xs) break;
    }
    this._writeBuffer.length > this._bufferOffset ? (this._bufferOffset > za && (this._writeBuffer = this._writeBuffer.slice(this._bufferOffset), this._callbacks = this._callbacks.slice(this._bufferOffset), this._bufferOffset = 0), setTimeout(() => this._innerWrite())) : (this._writeBuffer.length = 0, this._callbacks.length = 0, this._pendingData = 0, this._bufferOffset = 0), this._onWriteParsed.fire();
  }
}, Yi = class {
  constructor(e) {
  ...
  registerLink(e) {
    ...
    if (e.id === void 0) {
      let a = t.addMarker(t.ybase + t.y), l = { data: e, id: this._nextId++, lines: [a] };
...
var js = !1, $a = class extends P {
  constructor(e) {
    ...
    })), this._writeBuffer = this._register(new Fa((t, i) => this._inputHandler.parse(t, i))), this._register(oe.forward(this._writeBuffer.onWriteParsed, this._onWriteParsed));
  }
  get onScroll() {
  ...
  writeSync(e, t) {
    this._logService.logLevel <= 3 && !js && (this._logService.warn("writeSync is unreliable and will be removed soon."), js = !0), this._writeBuffer.writeSync(e, t);
  }
  input(e, t = !0) {
    this.coreService.triggerDataEvent(e, t);
  }
  resize(e, t) {
    isNaN(e) || isNaN(t) || (e = Math.max(e, $r), t = Math.max(t, Kr), this._bufferService.resize(e, t));
  }
  scroll(e, t = !1) {
  ...
  _enableWindowsWrappingHeuristics() {
    if (!this._windowsWrappingHeuristics.value) {
      let e = [];
      e.push(this.onLineFeed(zs.bind(null, this._bufferService))), e.push(this.registerCsiHandler({ final: "H" }, () => (zs(this._bufferService), !1))), this._windowsWrappingHeuristics.value = $(() => {
        for (let t of e) t.dispose();
      });
    }
  }
}, Ka = { 48: ["0", ")"], 49: ["1", "!"], 50: ["2", "@"], 51: ["3", "#"], 52: ["4", "$"], 53: ["5", "%"], 54: ["6", "^"], 55: ["7", "&"], 56: ["8", "*"], 57: ["9", "("], 186: [";", ":"], 187: ["=", "+"], 188: [",", "<"], 189: ["-", "_"], 190: [".", ">"], 191: ["/", "?"], 192: ["`", "~"], 219: ["[", "{"], 220: ["\\", "|"], 221: ["]", "}"], 222: ["'", '"'] };
function Ua(e, t, i, s) {
  let r = { type: 0, cancel: !1, key: void 0 }, n = (e.shiftKey ? 1 : 0) | (e.altKey ? 2 : 0) | (e.ctrlKey ? 4 : 0) | (e.metaKey ? 8 : 0);
  switch (e.keyCode) {
    case 0:
      e.key === "UIKeyInputUpArrow" ? t ? r.key = g.ESC + "OA" : r.key = g.ESC + "[A" : e.key === "UIKeyInputLeftArrow" ? t ? r.key = g.ESC + "OD" : r.key = g.ESC + "[D" : e.key === "UIKeyInputRightArrow" ? t ? r.key = g.ESC + "OC" : r.key = g.ESC + "[C" : e.key === "UIKeyInputDownArrow" && (t ? r.key = g.ESC + "OB" : r.key = g.ESC + "[B");
      break;
    case 8:
      r.key = e.ctrlKey ? "\b" : g.DEL, e.altKey && (r.key = g.ESC + r.key);
      break;
    case 9:
      if (e.shiftKey) {
        r.key = g.ESC + "[Z";
      ...
      r.key = g.HT, r.cancel = !0;
      break;
    case 13:
      r.key = e.altKey ? g.ESC + g.CR : g.CR, r.cancel = !0;
      break;
    case 27:
      r.key = g.ESC, e.altKey && (r.key = g.ESC + g.ESC), r.cancel = !0;
      break;
    case 37:
      if (e.metaKey) break;
      n ? r.key = g.ESC + "[1;" + (n + 1) + "D" : t ? r.key = g.ESC + "OD" : r.key = g.ESC + "[D";
      break;
    case 39:
      if (e.metaKey) break;
      n ? r.key = g.ESC + "[1;" + (n + 1) + "C" : t ? r.key = g.ESC + "OC" : r.key = g.ESC + "[C";
      break;
    case 38:
      if (e.metaKey) break;
      n ? r.key = g.ESC + "[1;" + (n + 1) + "A" : t ? r.key = g.ESC + "OA" : r.key = g.ESC + "[A";
      break;
    case 40:
      if (e.metaKey) break;
      n ? r.key = g.ESC + "[1;" + (n + 1) + "B" : t ? r.key = g.ESC + "OB" : r.key = g.ESC + "[B";
      break;
    case 45:
      !e.shiftKey && !e.ctrlKey && (r.key = g.ESC + "[2~");
      break;
    case 46:
      n ? r.key = g.ESC + "[3;" + (n + 1) + "~" : r.key = g.ESC + "[3~";
      break;
    case 36:
      n ? r.key = g.ESC + "[1;" + (n + 1) + "H" : t ? r.key = g.ESC + "OH" : r.key = g.ESC + "[H";
      break;
    case 35:
      n ? r.key = g.ESC + "[1;" + (n + 1) + "F" : t ? r.key = g.ESC + "OF" : r.key = g.ESC + "[F";
      break;
    case 33:
      e.shiftKey ? r.type = 2 : e.ctrlKey ? r.key = g.ESC + "[5;" + (n + 1) + "~" : r.key = g.ESC + "[5~";
      break;
    case 34:
      e.shiftKey ? r.type = 3 : e.ctrlKey ? r.key = g.ESC + "[6;" + (n + 1) + "~" : r.key = g.ESC + "[6~";
      break;
    case 112:
      n ? r.key = g.ESC + "[1;" + (n + 1) + "P" : r.key = g.ESC + "OP";
      break;
    case 113:
      n ? r.key = g.ESC + "[1;" + (n + 1) + "Q" : r.key = g.ESC + "OQ";
      break;
    case 114:
      n ? r.key = g.ESC + "[1;" + (n + 1) + "R" : r.key = g.ESC + "OR";
      break;
    case 115:
      n ? r.key = g.ESC + "[1;" + (n + 1) + "S" : r.key = g.ESC + "OS";
      break;
    case 116:
      n ? r.key = g.ESC + "[15;" + (n + 1) + "~" : r.key = g.ESC + "[15~";
      break;
    case 117:
      n ? r.key = g.ESC + "[17;" + (n + 1) + "~" : r.key = g.ESC + "[17~";
      break;
    case 118:
      n ? r.key = g.ESC + "[18;" + (n + 1) + "~" : r.key = g.ESC + "[18~";
      break;
    case 119:
      n ? r.key = g.ESC + "[19;" + (n + 1) + "~" : r.key = g.ESC + "[19~";
      break;
    case 120:
      n ? r.key = g.ESC + "[20;" + (n + 1) + "~" : r.key = g.ESC + "[20~";
      break;
    case 121:
      n ? r.key = g.ESC + "[21;" + (n + 1) + "~" : r.key = g.ESC + "[21~";
      break;
    case 122:
      n ? r.key = g.ESC + "[23;" + (n + 1) + "~" : r.key = g.ESC + "[23~";
      break;
    case 123:
      n ? r.key = g.ESC + "[24;" + (n + 1) + "~" : r.key = g.ESC + "[24~";
      break;
    default:
      if (e.ctrlKey && !e.shiftKey && !e.altKey && !e.metaKey) e.keyCode >= 65 && e.keyCode <= 90 ? r.key = String.fromCharCode(e.keyCode - 64) : e.keyCode === 32 ? r.key = g.NUL : e.keyCode >= 51 && e.keyCode <= 55 ? r.key = String.fromCharCode(e.keyCode - 51 + 27) : e.keyCode === 56 ? r.key = g.DEL : e.keyCode === 219 ? r.key = g.ESC : e.keyCode === 220 ? r.key = g.FS : e.keyCode === 221 && (r.key = g.GS);
      else if ((!i || s) && e.altKey && !e.metaKey) {
        let o = Ka[e.keyCode]?.[e.shiftKey ? 1 : 0];
        if (o) r.key = g.ESC + o;
        else if (e.keyCode >= 65 && e.keyCode <= 90) {
          let a = e.ctrlKey ? e.keyCode - 64 : e.keyCode + 32, l = String.fromCharCode(a);
          e.shiftKey && (l = l.toUpperCase()), r.key = g.ESC + l;
        } else if (e.keyCode === 32) r.key = g.ESC + (e.ctrlKey ? g.NUL : " ");
        else if (e.key === "Dead" && e.code.startsWith("Key")) {
          let a = e.code.slice(3, 4);
          e.shiftKey || (a = a.toLowerCase()), r.key = g.ESC + a, r.cancel = !0;
        }
      } else i && !e.altKey && !e.ctrlKey && !e.shiftKey && e.metaKey ? e.keyCode === 65 && (r.type = 1) : e.key && !e.ctrlKey && !e.altKey && !e.metaKey && e.keyCode >= 48 && e.key.length === 1 ? r.key = e.key : e.key && e.ctrlKey && (e.key === "_" && (r.key = g.US), e.key === "@" && (r.key = g.NUL));
      break;
  }
  return r;
}
...
}, di = 0, Gs = 0, Va = class extends P {
  constructor() {
    super(), this._decorations = new qa((e) => e?.marker.line), this._onDecorationRegistered = this._register(new m()), this.onDecorationRegistered = this._onDecorationRegistered.event, this._onDecorationRemoved = this._register(new m()), this.onDecorationRemoved = this._onDecorationRemoved.event, this._register($(() => this.reset()));
  }
  get decorations() {
  ...
  *getDecorationsAtCell(e, t, i) {
  ...
  forEachDecorationAtCell(e, t, i, s) {
    this._decorations.forEachByKey(t, (r) => {
      di = r.options.x ?? 0, Gs = di + (r.options.width ?? 1), e >= di && e < Gs && (!i || (r.options.layer ?? "bottom") === i) && s(r);
    });
  }
}, Ya = class extends qe {
  constructor(e) {
...
`))), this._register(this._terminal.onA11yTab((n) => this._handleTab(n))), this._register(this._terminal.onKey((n) => this._handleKey(n.key))), this._register(this._terminal.onBlur(() => this._clearLiveRegion())), this._register(this._renderService.onDimensionsChange(() => this._refreshRowsDimensions())), this._register(R(r, "selectionchange", () => this._handleSelectionChange())), this._register(this._coreBrowserService.onDprChange(() => this._refreshRowsDimensions())), this._refreshRowsDimensions(), this._refreshRows(), this._register($(() => {
  ...
  _handleChar(e) {
    this._liveRegionLineCount < Js + 1 && (this._charsToConsume.length > 0 ? this._charsToConsume.shift() !== e && (this._charsToAnnounce += e) : this._charsToAnnounce += e, e === `
` && (this._liveRegionLineCount++, this._liveRegionLineCount === Js + 1 && (this._liveRegion.textContent += _i.get())));
  }
  _clearLiveRegion() {
  ...
  _renderRows(e, t) {
    ...
    for (let r = e; r <= t; r++) {
      let n = i.lines.get(i.ydisp + r), o = [], a = n?.translateToString(!0, void 0, void 0, o) || "", l = (i.ydisp + r + 1).toString(), h = this._rowElements[r];
  ...
  _handleSelectionChange() {
    ...
    let r = ({ node: a, offset: l }) => {
      let h = a instanceof Text ? a.parentNode : a, c = parseInt(h?.getAttribute("aria-posinset"), 10) - 1;
      if (isNaN(c)) return console.warn("row is invalid. Race condition?"), null;
      let d = this._rowColumns.get(h);
      if (!d) return console.warn("columns is null. Race condition?"), null;
      let _ = l < d.length ? d[l] : d.slice(-1)[0] + 1;
      return _ >= this._terminal.cols && (++c, _ = 0), { row: c, column: _ };
    }, n = r(t), o = r(i);
    if (!(!n || !o)) {
...
Vt = Y([w(1, ji), w(2, Oe), w(3, Ie)], Vt);
var Xi = class extends P {
  constructor(e, t, i, s, r) {
    super(), this._element = e, this._mouseService = t, this._renderService = i, this._bufferService = s, this._linkProviderService = r, this._linkCacheDisposables = [], this._isMouseOut = !0, this._wasResized = !1, this._activeLine = -1, this._onShowLinkUnderline = this._register(new m()), this.onShowLinkUnderline = this._onShowLinkUnderline.event, this._onHideLinkUnderline = this._register(new m()), this.onHideLinkUnderline = this._onHideLinkUnderline.event, this._register($(() => {
      Ze(this._linkCacheDisposables), this._linkCacheDisposables.length = 0, this._lastMouseEvent = void 0, this._activeProviderReplies?.clear();
  ...
  _removeIntersectingLinks(e, t) {
    ...
    for (let s = 0; s < t.size; s++) {
      ...
      if (r) for (let n = 0; n < r.length; n++) {
        let o = r[n], a = o.link.range.start.y < e ? 0 : o.link.range.start.x, l = o.link.range.end.y > e ? this._bufferService.cols : o.link.range.end.x;
        for (let h = a; h <= l; h++) {
          if (i.has(h)) {
            r.splice(n--, 1);
            break;
  ...
  _handleMouseUp(e) {
    ...
    let t = this._positionFromMouseEvent(e, this._element, this._mouseService);
    t && this._mouseDownLink && Ga(this._mouseDownLink.link, this._currentLink.link) && this._linkAtPosition(this._currentLink.link, t) && this._currentLink.link.activate(e, this._currentLink.link.text);
  }
  _clearCurrentLink(e, t) {
    !this._currentLink || !this._lastMouseEvent || (!e || !t || this._currentLink.link.range.start.y >= e && this._currentLink.link.range.end.y <= t) && (this._linkLeave(this._element, this._currentLink.link, this._lastMouseEvent), this._currentLink = void 0, Ze(this._linkCacheDisposables), this._linkCacheDisposables.length = 0);
  }
  _handleNewLink(e) {
...
Xi = Y([w(1, Gi), w(2, Ie), w(3, ce), w(4, ur)], Xi);
function Ga(e, t) {
...
var Ja = class extends $a {
    ...
    if (this._themeService) for (let t of e) {
      ...
      switch (t.type) {
        case 0:
          ...
          this.coreService.triggerDataEvent(`${g.ESC}]${s};${Ia(r)}${Rr.ST}`);
          break;
        case 1:
          if (i === "ansi") this._themeService.modifyColors((n) => n.ansi[t.index] = G.toColor(...t.color));
          else {
            let n = i;
            this._themeService.modifyColors((o) => o[n] = G.toColor(...t.color));
          }
          break;
        case 2:
  ...
  _handleScreenReaderModeOptionChange(e) {
    e ? !this._accessibilityManager.value && this._renderService && (this._accessibilityManager.value = this._instantiationService.createInstance(Vt, this)) : this._accessibilityManager.clear();
  }
  _handleTextAreaFocus(e) {
    this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(g.ESC + "[I"), this.element.classList.add("focus"), this._showCursor(), this._onFocus.fire();
  }
  blur() {
    return this.textarea?.blur();
  }
  _handleTextAreaBlur() {
    this.textarea.value = "", this.refresh(this.buffer.y, this.buffer.y), this.coreService.decPrivateModes.sendFocus && this.coreService.triggerDataEvent(g.ESC + "[O"), this.element.classList.remove("focus"), this._onBlur.fire();
  }
  _syncTextArea() {
  ...
  _initGlobal() {
    this._bindKeys(), this._register(R(this.element, "copy", (t) => {
      this.hasSelection() && Qr(t, this._selectionService);
    }));
    let e = (t) => en(t, this.textarea, this.coreService, this.optionsService);
    this._register(R(this.textarea, "paste", e)), this._register(R(this.element, "paste", e)), Pr ? this._register(R(this.element, "mousedown", (t) => {
      t.button === 2 && as(t, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
    })) : this._register(R(this.element, "contextmenu", (t) => {
      as(t, this.textarea, this.screenElement, this._selectionService, this.options.rightClickSelectsWord);
    })), rs && this._register(R(this.element, "auxclick", (t) => {
      t.button === 1 && sr(t, this.textarea, this.screenElement);
    }));
  }
  _bindKeys() {
  ...
  open(e) {
    ...
    })), this._register(this.onResize(() => this._renderService.handleResize(this.cols, this.rows))), this._register(this.onBlur(() => this._renderService.handleBlur())), this._register(this.onFocus(() => this._renderService.handleFocus())), this._viewport = this._register(this._instantiationService.createInstance(Li, this.element, this.screenElement)), this._register(this._viewport.onRequestScrollLines((r) => {
      super.scrollLines(r, !1), this.refresh(0, this.rows - 1);
    })), this._selectionService = this._register(this._instantiationService.createInstance(Wi, this.element, this.screenElement, s)), this._instantiationService.setService(ln, this._selectionService), this._register(this._selectionService.onRequestScrollLines((r) => this.scrollLines(r.amount, r.suppressScrollEvent))), this._register(this._selectionService.onSelectionChange(() => this._onSelectionChange.fire())), this._register(this._selectionService.onRequestRedraw((r) => this._renderService.handleSelectionChanged(r.start, r.end, r.columnSelectMode))), this._register(this._selectionService.onLinuxMouseSelection((r) => {
  ...
  bindMouse() {
    ...
    function i(n) {
      ...
      switch (n.overrideType || n.type) {
        case "mousemove":
          l = 32, n.buttons === void 0 ? (a = 3, n.button !== void 0 && (a = n.button < 3 ? n.button : 3)) : a = n.buttons & 1 ? 0 : n.buttons & 4 ? 1 : n.buttons & 2 ? 2 : 3;
          break;
        case "mouseup":
          l = 0, a = n.button < 3 ? n.button : 3;
          break;
        case "mousedown":
          l = 1, a = n.button < 3 ? n.button : 3;
          break;
        case "wheel":
          if (e._customWheelEventHandler && e._customWheelEventHandler(n) === !1) return !1;
          let h = n.deltaY;
          if (h === 0 || e.coreMouseService.consumeWheelEvent(n, e._renderService?.dimensions?.device?.cell?.height, e._coreBrowserService?.dpr) === 0) return !1;
          l = h < 0 ? 0 : 1, a = 4;
          break;
        default:
          return !1;
      }
      return l === void 0 || a === void 0 || a > 4 ? !1 : e.coreMouseService.triggerMouseEvent({ col: o.col, row: o.row, x: o.x, y: o.y, button: a, action: l, ctrl: n.ctrlKey, alt: n.altKey, shift: n.shiftKey });
    }
    ...
    this._register(this.coreMouseService.onProtocolChange((n) => {
      ...
      if (!s.wheel) {
        ...
        if (!this.buffer.hasScrollback) {
          ...
          let o = g.ESC + (this.coreService.decPrivateModes.applicationCursorKeys ? "O" : "[") + (n.deltaY < 0 ? "A" : "B");
  ...
  _keyDown(e) {
    ...
    let i = Ua(e, this.coreService.decPrivateModes.applicationCursorKeys, this.browser.isMac, this.options.macOptionIsMeta);
    ...
    if ((i.key === g.ETX || i.key === g.CR) && (this.textarea.value = ""), this._onKey.fire({ key: i.key, domEvent: e }), this._showCursor(), this.coreService.triggerDataEvent(i.key, !0), !this.optionsService.rawOptions.screenReaderMode || e.altKey || e.ctrlKey) return this.cancel(e, !0);
  ...
  _keyUp(e) {
    this._keyDownSeen = !1, !(this._customKeyEventHandler && this._customKeyEventHandler(e) === !1) && (Za(e) || this.focus(), this.updateCursorStyle(e), this._keyPressHandled = !1);
  }
  _keyPress(e) {
    let t;
  ...
  _reportFocus() {
    this.element?.classList.contains("focus") ? this.coreService.triggerDataEvent(g.ESC + "[I") : this.coreService.triggerDataEvent(g.ESC + "[O");
  }
...
var Qa = class {
  ...
  constructor(e) {
    super(), this._core = e, this._onBufferChange = this._register(new m()), this.onBufferChange = this._onBufferChange.event, this._normal = new Zs(this._core.buffers.normal, "normal"), this._alternate = new Zs(this._core.buffers.alt, "alternate"), this._core.buffers.onBufferActivate(() => this._onBufferChange.fire(this.active));
  }
  get active() {
...
}, rh = ["cols", "rows"], Ee = 0, nh = class extends P {
  constructor(e) {
    super(), this._core = this._register(new Ja(e)), this._addonManager = this._register(new Qa()), this._publicOptions = { ...this._core.options };
  ...
  _checkReadonlyOptions(e) {
    if (rh.includes(e)) throw new Error(`Option "${e}" can only be set in the constructor`);
  }
  _checkProposedApi() {
  ...
  get parser() {
    return this._parser || (this._parser = new ih(this._core)), this._parser;
  }
  get unicode() {
    return this._checkProposedApi(), new sh(this._core);
  }
  get textarea() {
  ...
  get buffer() {
    return this._buffer || (this._buffer = this._register(new th(this._core))), this._buffer;
  }
  get markers() {
...
`, t);
  ...
  _verifyIntegers(...e) {
    for (Ee of e) if (Ee === 1 / 0 || isNaN(Ee) || Ee % 1 !== 0) throw new Error("This API only accepts integers");
  }
  _verifyPositiveIntegers(...e) {
    for (Ee of e) if (Ee && (Ee === 1 / 0 || isNaN(Ee) || Ee % 1 !== 0 || Ee < 0)) throw new Error("This API only accepts positive integers");
  }
};
const oh = ".xterm{cursor:text;position:relative;user-select:none;-ms-user-select:none;-webkit-user-select:none}.xterm.focus,.xterm:focus{outline:none}.xterm .xterm-helpers{position:absolute;top:0;z-index:5}.xterm .xterm-helper-textarea{padding:0;border:0;margin:0;position:absolute;opacity:0;left:-9999em;top:0;width:0;height:0;z-index:-5;white-space:nowrap;overflow:hidden;resize:none}.xterm .composition-view{background:#000;color:#fff;display:none;position:absolute;white-space:nowrap;z-index:1}.xterm .composition-view.active{display:block}.xterm .xterm-viewport{background-color:#000;overflow-y:scroll;cursor:default;position:absolute;inset:0}.xterm .xterm-screen{position:relative}.xterm .xterm-screen canvas{position:absolute;left:0;top:0}.xterm-char-measure-element{display:inline-block;visibility:hidden;position:absolute;top:0;left:-9999em;line-height:normal}.xterm.enable-mouse-events{cursor:default}.xterm.xterm-cursor-pointer,.xterm .xterm-cursor-pointer{cursor:pointer}.xterm.column-select.focus{cursor:crosshair}.xterm .xterm-accessibility:not(.debug),.xterm .xterm-message{position:absolute;inset:0;z-index:10;color:transparent;pointer-events:none}.xterm .xterm-accessibility-tree:not(.debug) *::selection{color:transparent}.xterm .xterm-accessibility-tree{font-family:monospace;-webkit-user-select:text;user-select:text;white-space:pre}.xterm .xterm-accessibility-tree>div{transform-origin:left;width:fit-content}.xterm .live-region{position:absolute;left:-9999px;width:1px;height:1px;overflow:hidden}.xterm-dim{opacity:1!important}.xterm-underline-1{text-decoration:underline}.xterm-underline-2{text-decoration:double underline}.xterm-underline-3{text-decoration:wavy underline}.xterm-underline-4{text-decoration:dotted underline}.xterm-underline-5{text-decoration:dashed underline}.xterm-overline{text-decoration:overline}.xterm-overline.xterm-underline-1{text-decoration:overline underline}.xterm-overline.xterm-underline-2{text-decoration:overline double underline}.xterm-overline.xterm-underline-3{text-decoration:overline wavy underline}.xterm-overline.xterm-underline-4{text-decoration:overline dotted underline}.xterm-overline.xterm-underline-5{text-decoration:overline dashed underline}.xterm-strikethrough{text-decoration:line-through}.xterm-screen .xterm-decoration-container .xterm-decoration{z-index:6;position:absolute}.xterm-screen .xterm-decoration-container .xterm-decoration.xterm-decoration-top-layer{z-index:7}.xterm-decoration-overview-ruler{z-index:8;position:absolute;top:0;right:0;pointer-events:none}.xterm-decoration-top{z-index:2;position:relative}.xterm .xterm-scrollable-element>.scrollbar{cursor:default}.xterm .xterm-scrollable-element>.scrollbar>.scra{cursor:pointer;font-size:11px!important}.xterm .xterm-scrollable-element>.visible{opacity:1;background:#0000;transition:opacity .1s linear;z-index:11}.xterm .xterm-scrollable-element>.invisible{opacity:0;pointer-events:none}.xterm .xterm-scrollable-element>.invisible.fade{transition:opacity .8s linear}.xterm .xterm-scrollable-element>.shadow{position:absolute;display:none}.xterm .xterm-scrollable-element>.shadow.top{display:block;top:0;left:3px;height:3px;width:100%;box-shadow:var(--vscode-scrollbar-shadow, #000) 0 6px 6px -6px inset}.xterm .xterm-scrollable-element>.shadow.left{display:block;top:3px;left:0;height:100%;width:3px;box-shadow:var(--vscode-scrollbar-shadow, #000) 6px 0 6px -6px inset}.xterm .xterm-scrollable-element>.shadow.top-left-corner{display:block;top:0;left:0;height:3px;width:3px}.xterm .xterm-scrollable-element>.shadow.top.left{box-shadow:var(--vscode-scrollbar-shadow, #000) 6px 0 6px -6px inset}", ah = ":host{display:block;width:100%;height:100%;min-height:20rem;color-scheme:dark;background:#06090d}.terminal-app{box-sizing:border-box;display:grid;grid-template-rows:minmax(0,1fr) auto;width:100%;height:100%;min-height:20rem;overflow:hidden;background:#06090d}.terminal-app__surface{box-sizing:border-box;min-width:0;min-height:0;overflow:hidden;padding:.5rem}.terminal-app__surface .xterm{height:100%}.terminal-app__surface .xterm-viewport{scrollbar-color:#34445a #0b1017}.terminal-app__status{padding:.55rem .75rem;color:#93a4b8;background:#111720;font:13px/1.4 ui-sans-serif,system-ui,sans-serif}.terminal-app__status--error{color:#fecdd3;background:#4c0519}.terminal-app__status[hidden]{display:none}", hh = "/api/bash/execute_bash_command", lh = 300;
function At(e, t) {
...
function ch(e) {
  return typeof e == "string" && e.startsWith("/") && e.length <= 4096 && !/[\0-\x1f\x7f]/.test(e);
}
function er(e) {
  return e instanceof Error ? e.message : "The command request failed.";
}
function dh(e, t) {
  const i = e.attachShadow({ mode: "open" }), s = At("style");
  s.textContent = `${oh}
${ah}`;
  const r = At("main", "terminal-app"), n = At("div", "terminal-app__surface");
  n.setAttribute("aria-label", "Terminal command runner");
  const o = At("div", "terminal-app__status");
  o.setAttribute("role", "status"), o.setAttribute("aria-live", "polite"), o.hidden = !0, r.append(n, o), i.append(s, r);
  const a = new nh({
    cursorBlink: !0,
    cursorStyle: "block",
    convertEol: !0,
  ...
  a.loadAddon(l), a.open(n), l.fit(), a.focus();
  let h = "", c = "", d = !1, _ = !1, f = !1, u = 0;
  const p = [], S = (D = "", A = !1) => {
    o.textContent = D, o.classList.toggle("terminal-app__status--error", A), o.hidden = D.length === 0;
  }, x = () => a.write(`\x1B[32m${h}\x1B[0m $ `), H = (D) => {
    c.length > 0 && a.write(`\x1B[${c.length}D\x1B[K`), c = D, a.write(c);
  };
  async function T(D) {
    _ = !0, S("Running…");
    try {
      const A = await t.agentServer.request({
        method: "POST",
        path: hh,
        body: { command: D, cwd: h, timeout: lh }
      });
      if (f) return;
      const W = Qs(A, "The Agent Server returned invalid command output."), he = typeof W?.stdout == "string" ? W.stdout : "", Le = typeof W?.stderr == "string" ? W.stderr : "";
      he && a.write(he), Le && a.write(`\x1B[31m${Le}\x1B[0m`), (he || Le) && !`${he}${Le}`.endsWith(`
`) && a.write(`\r
`), typeof W?.exit_code == "number" && W.exit_code !== 0 && a.writeln(`\x1B[90m[exit ${W.exit_code}]\x1B[0m`), S();
    } catch (A) {
      if (f) return;
      const W = er(A);
      a.writeln(`\x1B[31m${W}\x1B[0m`), S(W, !0);
    } finally {
      f || (_ = !1, x(), a.focus());
    }
  }
  const B = a.onData((D) => {
    if (!(!d || _)) {
      if (D === "\x1B[A" || D === "\x1B[B") {
        D === "\x1B[A" && u > 0 && (u -= 1), D === "\x1B[B" && u < p.length && (u += 1), H(p[u] ?? "");
        return;
      }
      for (const A of D) {
        if (A === "\r" || A === `
...
`);
          ...
          p.push(W), u = p.length, T(W);
          return;
        }
        A === "" ? c.length > 0 && (c = c.slice(0, -1), a.write("\b \b")) : A === "" ? (c = "", a.write(`^C\r
`), x()) : A === "\f" ? (a.clear(), x(), a.write(c)) : A >= " " && (c += A, a.write(A));
      }
    }
  ...
  return O.observe(n), n.addEventListener("click", () => a.focus()), t.agentServer.request({ path: "/api/file/home" }).then((D) => {
    if (f) return;
    const A = Qs(D, "The Agent Server returned an invalid home directory.");
    if (!ch(A?.home)) throw new Error("The Agent Server did not report a valid home directory.");
    h = A.home, d = !0, a.writeln("\x1B[90mCommands run through the active backend.\x1B[0m"), x(), a.focus();
  }).catch((D) => {
    if (f) return;
    const A = er(D);
    a.writeln(`\x1B[31m${A}\x1B[0m`), S(A, !0);
  }), () => {
    f = !0, d = !1, B.dispose(), O.disconnect(), a.dispose(), i.replaceChildren(), e.replaceChildren();
  };
}
function uh(e, t) {
  const i = document.createElement("style");
  i.dataset.terminal = "styles", i.textContent = qr;
  const s = document.createElement("section");
  s.className = "terminal-shell";
  const r = document.createElement("div");
  r.className = "terminal-shell__mount", s.append(r), t.container.append(i, s);
  const n = dh(r, e);
  return () => {
    n(), s.remove(), i.remove();
  };
...
function ph(e) {
  if (e.apiVersion !== "1") throw new Error("Terminal requires Canvas host API 1.");
  return e.registerPage("terminal", (t) => uh(e, t));
}
export {
  ph as activate
};
